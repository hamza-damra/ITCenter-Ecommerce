...
@section('title', __('messages.order_confirmed_title') . ' - IT Center')
...
<div class="confirmation-page">
    ...
    <div class="confirmation-hero">
        ...
        <h1>{{ __('messages.order_confirmed_title') }}</h1>
        <p>{{ __('messages.order_confirmed_subtitle') }}</p>
    </div>
    ...
    <div class="shipping-info-card">
        ...
        <div class="shipping-details">
            <div class="shipping-detail-item">
                <span class="detail-label">{{ __('messages.name') ?? 'Name' }}</span>
            ...
            <div class="shipping-detail-item">
                <span class="detail-label">{{ __('messages.street_address') }}</span>
            ...
            <div class="shipping-detail-item">
                <span class="detail-label">{{ __('messages.payment_method') }}</span>
                <span class="detail-value">{{ __('messages.cash_on_delivery') }}</span>
            </div>
            @if($order->notes)
                <div class="shipping-detail-item" style="grid-column: 1 / -1;">
                    <span class="detail-label">{{ __('messages.order_notes') }}</span>
    ...
    <div class="confirmation-note">
        ...
        <span>{{ __('messages.order_confirmed_note') }}</span>
    </div>

    <!-- Action Buttons -->
    <div class="confirmation-actions">
        <a href="{{ route('orders.show', $order->order_number) }}" class="conf-btn conf-btn-primary">
            <i class="fas fa-eye"></i>
            {{ __('messages.view_order_details') }}
        </a>
        <a href="{{ route('home') }}" class="conf-btn conf-btn-secondary">
            <i class="fas fa-shopping-bag"></i>
            {{ __('messages.continue_shopping_home') }}
        </a>
    </div>
</div>
...
{{-- Detect bfcache restore (e.g. user navigated away then pressed Back to this page) --}}
<script>
