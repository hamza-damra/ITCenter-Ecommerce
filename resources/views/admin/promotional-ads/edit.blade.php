                ...
                <div class="form-row" style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    <div class="form-group">
                        ...
                        <input type="text" id="title_en" name="title_en" class="form-control @error('title_en') is-invalid @enderror" 
                            value="{{ old('title_en', $promotionalAd->title_en) }}" placeholder="{{ __('messages.title_english_placeholder') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="title_ar" name="title_ar" class="form-control @error('title_ar') is-invalid @enderror" 
                            value="{{ old('title_ar', $promotionalAd->title_ar) }}" placeholder="{{ __('messages.title_arabic_placeholder') }}" dir="rtl">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="title_he" name="title_he" class="form-control @error('title_he') is-invalid @enderror" 
                            value="{{ old('title_he', $promotionalAd->title_he) }}" placeholder="{{ __('messages.title_hebrew_placeholder') }}" dir="rtl">
                ...
                <div class="form-row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 16px;">
                    <div class="form-group">
                        ...
                        <div style="display: flex; gap: 8px; align-items: center;">
                            <input type="color" id="title_color_picker" value="{{ old('title_color', $promotionalAd->title_color ?? '#FFFFFF') }}" 
                            ...
                            <input type="text" id="title_color" name="title_color" class="form-control @error('title_color') is-invalid @enderror" 
                                value="{{ old('title_color', $promotionalAd->title_color) }}" placeholder="#FFFFFF" pattern="^#[0-9A-Fa-f]{6}$"
                    ...
                    <div class="form-group">
                        ...
                        <select id="title_font_size" name="title_font_size" class="form-control @error('title_font_size') is-invalid @enderror">
                            ...
                            <option value="24px" {{ old('title_font_size', $promotionalAd->title_font_size) == '24px' ? 'selected' : '' }}>24px - {{ __('messages.small') }}</option>
                            <option value="32px" {{ old('title_font_size', $promotionalAd->title_font_size) == '32px' ? 'selected' : '' }}>32px - {{ __('messages.medium') }}</option>
                            <option value="40px" {{ old('title_font_size', $promotionalAd->title_font_size) == '40px' ? 'selected' : '' }}>40px - {{ __('messages.large') }}</option>
                            <option value="48px" {{ old('title_font_size', $promotionalAd->title_font_size) == '48px' ? 'selected' : '' }}>48px - {{ __('messages.extra_large') }}</option>
                        </select>
            ...
            <div class="card-body">
                <div class="form-row" style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    <div class="form-group">
                        ...
                        <input type="text" id="subtitle_en" name="subtitle_en" class="form-control @error('subtitle_en') is-invalid @enderror" 
                            value="{{ old('subtitle_en', $promotionalAd->subtitle_en) }}" placeholder="{{ __('messages.subtitle_english_placeholder') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="subtitle_ar" name="subtitle_ar" class="form-control @error('subtitle_ar') is-invalid @enderror" 
                            value="{{ old('subtitle_ar', $promotionalAd->subtitle_ar) }}" placeholder="{{ __('messages.subtitle_arabic_placeholder') }}" dir="rtl">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="subtitle_he" name="subtitle_he" class="form-control @error('subtitle_he') is-invalid @enderror" 
                            value="{{ old('subtitle_he', $promotionalAd->subtitle_he) }}" placeholder="{{ __('messages.subtitle_hebrew_placeholder') }}" dir="rtl">
                ...
                <div class="form-row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 16px;">
                    <div class="form-group">
                        ...
                        <div style="display: flex; gap: 8px; align-items: center;">
                            <input type="color" id="subtitle_color_picker" value="{{ old('subtitle_color', $promotionalAd->subtitle_color ?? '#FFFFFF') }}" 
                                style="width: 50px; height: 38px; border: 1px solid var(--border); border-radius: 4px; cursor: pointer;"
                            ...
                            <input type="text" id="subtitle_color" name="subtitle_color" class="form-control @error('subtitle_color') is-invalid @enderror" 
                                value="{{ old('subtitle_color', $promotionalAd->subtitle_color) }}" placeholder="#FFFFFF" pattern="^#[0-9A-Fa-f]{6}$"
                    ...
                    <div class="form-group">
                        ...
                        <select id="subtitle_font_size" name="subtitle_font_size" class="form-control @error('subtitle_font_size') is-invalid @enderror">
                            <option value="">{{ __('messages.select_font_size') }}</option>
                            <option value="14px" {{ old('subtitle_font_size', $promotionalAd->subtitle_font_size) == '14px' ? 'selected' : '' }}>14px - {{ __('messages.small') }}</option>
                            <option value="16px" {{ old('subtitle_font_size', $promotionalAd->subtitle_font_size) == '16px' ? 'selected' : '' }}>16px - {{ __('messages.medium') }}</option>
                            <option value="18px" {{ old('subtitle_font_size', $promotionalAd->subtitle_font_size) == '18px' ? 'selected' : '' }}>18px - {{ __('messages.large') }}</option>
                            <option value="20px" {{ old('subtitle_font_size', $promotionalAd->subtitle_font_size) == '20px' ? 'selected' : '' }}>20px - {{ __('messages.extra_large') }}</option>
                        </select>
            ...
            <div class="card-body">
                <div class="form-row" style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    <div class="form-group">
                        ...
                        <input type="text" id="button_text_en" name="button_text_en" class="form-control @error('button_text_en') is-invalid @enderror" 
                            value="{{ old('button_text_en', $promotionalAd->button_text_en) }}" placeholder="{{ __('messages.button_text_english_placeholder') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="button_text_ar" name="button_text_ar" class="form-control @error('button_text_ar') is-invalid @enderror" 
                            value="{{ old('button_text_ar', $promotionalAd->button_text_ar) }}" placeholder="{{ __('messages.button_text_arabic_placeholder') }}" dir="rtl">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="button_text_he" name="button_text_he" class="form-control @error('button_text_he') is-invalid @enderror" 
                            value="{{ old('button_text_he', $promotionalAd->button_text_he) }}" placeholder="{{ __('messages.button_text_hebrew_placeholder') }}" dir="rtl">
                ...
                <div class="form-row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 16px;">
                    <div class="form-group">
                        ...
                        <div style="display: flex; gap: 8px; align-items: center;">
                            <input type="color" id="button_bg_color_picker" value="{{ old('button_bg_color', $promotionalAd->button_bg_color ?? '#2563eb') }}" 
                                style="width: 50px; height: 38px; border: 1px solid var(--border); border-radius: 4px; cursor: pointer;"
                            ...
                            <input type="text" id="button_bg_color" name="button_bg_color" class="form-control @error('button_bg_color') is-invalid @enderror" 
                                value="{{ old('button_bg_color', $promotionalAd->button_bg_color) }}" placeholder="#2563eb" pattern="^#[0-9A-Fa-f]{6}$"
                    ...
                    <div class="form-group">
                        ...
                        <div style="display: flex; gap: 8px; align-items: center;">
                            <input type="color" id="button_text_color_picker" value="{{ old('button_text_color', $promotionalAd->button_text_color ?? '#FFFFFF') }}" 
                                style="width: 50px; height: 38px; border: 1px solid var(--border); border-radius: 4px; cursor: pointer;"
                            ...
                            <input type="text" id="button_text_color" name="button_text_color" class="form-control @error('button_text_color') is-invalid @enderror" 
                                value="{{ old('button_text_color', $promotionalAd->button_text_color) }}" placeholder="#FFFFFF" pattern="^#[0-9A-Fa-f]{6}$"
