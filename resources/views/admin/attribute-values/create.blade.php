...
@section('title', 'Add New Value - ' . $attribute->name_en)
...
<div class="attribute-info">
    <h2>Adding value to: {{ $attribute->name_en }}</h2>
    <div class="meta">
...
<div class="page-header">
    <div class="page-header-content">
        <h1>Add New Value</h1>
        <p>Create a new value for {{ $attribute->name_en }}</p>
    </div>
</div>
...
<div class="form-container">
    <form action="{{ route('admin.attribute-values.store', $attribute) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="value_en" name="value_en" value="{{ old('value_en') }}" required>
            @error('value_en')
        ...
        <div class="form-group">
            ...
            <input type="text" id="value_ar" name="value_ar" value="{{ old('value_ar') }}" required dir="rtl">
            @error('value_ar')
                <div class="help-text" style="color: #dc2626;">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="value_he" name="value_he" value="{{ old('value_he') }}" required dir="rtl">
            @error('value_he')
                <div class="help-text" style="color: #dc2626;">{{ $message }}</div>
            @enderror
        </div>
        ...
        @if($attribute->type === 'color')
            <div class="form-group">
                ...
                <div class="color-preview-container">
                    <input type="color" id="color_code" name="color_code" value="{{ old('color_code', '#000000') }}" style="width: 80px; height: 50px; cursor: pointer;">
                    <input type="text" id="color_code_text" value="{{ old('color_code', '#000000') }}" style="width: 120px;" readonly>
                </div>
