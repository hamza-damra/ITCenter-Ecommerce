...
<div class="contacts-header">
    <h1><i class="fas fa-envelope"></i> {{ __('messages.contact_messages_management') }}</h1>
...
<div class="stats-grid">
    <div class="stat-card total">
        <h3><i class="fas fa-envelope"></i> {{ __('messages.total_messages') }}</h3>
        <div class="stat-value">{{ $stats['total_messages'] }}</div>
    </div>
    <div class="stat-card pending">
        <h3><i class="fas fa-clock"></i> {{ __('messages.pending') }}</h3>
        <div class="stat-value">{{ $stats['pending_messages'] }}</div>
    </div>
    <div class="stat-card read">
        <h3><i class="fas fa-envelope-open"></i> {{ __('messages.read') }}</h3>
        <div class="stat-value">{{ $stats['read_messages'] }}</div>
    </div>
    <div class="stat-card archived">
        <h3><i class="fas fa-archive"></i> {{ __('messages.archived') }}</h3>
...
<div class="bulk-actions" id="bulkActions">
    ...
    <form action="{{ route('admin.contacts.bulk-update-status') }}" method="POST" style="display: flex; gap: 10px; align-items: center;">
        @csrf
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <a href="{{ route('admin.contacts.show', $message->id) }}" class="btn btn-view" title="{{ __('messages.view_details') }}">
                            <i class="fas fa-eye"></i>
                        </a>
                        <form action="{{ route('admin.contacts.destroy', $message->id) }}" method="POST" onsubmit="return confirm('{{ __('messages.are_you_sure') }}')">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-delete" title="{{ __('messages.delete') }}">
