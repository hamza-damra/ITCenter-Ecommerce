...
<form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data" class="category-form-grid">
    @csrf
    @method('PUT')
...
<script>
    ...
    function deleteCurrentImage(buttonEl) {
        ...
        const url = '{{ route("admin.categories.delete-image", $category->id) }}';
