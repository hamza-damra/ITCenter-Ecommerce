...
@section('title', __('messages.refund_policy_page_title') . ' - IT Center')
...
<div class="page-header">
    <div class="container">
        <h1><i class="fas fa-undo-alt"></i> {{ __('messages.refund_policy_page_title') }}</h1>
        <p>{{ __('messages.refund_policy_subtitle') }}</p>
    </div>
</div>
