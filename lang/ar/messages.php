...
return [
    ...
    'shipping_palestine_only' => 'نقوم بالشحن حالياً فقط داخل فلسطين (الضفة الغربية والداخل المحتل 48). الشحن إلى غزة غير متاح حالياً.',
    'shipping_country_locked' => 'الشحن إلى فلسطين فقط',
    'postal_code_mismatch' => 'الرمز البريدي لا يتطابق مع المدينة المختارة. النطاق الصحيح: :min – :max',
    'postal_code_valid' => 'الرمز البريدي صحيح',
    'postal_hint_range' => 'النطاق الصحيح: :min – :max',
    'city_selected_success' => 'تم اختيار المدينة',
    'select_city_first' => 'يرجى اختيار المدينة أولاً',
    'invalid_postal_format' => 'يجب أن يبدأ الرمز البريدي بحرف P متبوعاً بـ :digits أرقام (مثال: P5840719)',
    'no_shipping_to_gaza' => 'عذراً، الشحن إلى غزة غير متاح حالياً',
    'invalid_city_selected' => 'المدينة المختارة غير صالحة للشحن',
    'please_login_to_checkout' => 'يرجى تسجيل الدخول للمتابعة إلى صفحة الدفع',
    'must_login_to_place_order' => 'يجب تسجيل الدخول لإتمام الطلب',
    'deleted_products_removed_from_cart' => 'تمت إزالة بعض المنتجات من سلتك لأنها لم تعد متوفرة',

    // Admin Shipping Management
    'shipping_management' => 'إدارة الشحن',
    'shipping_management_subtitle' => 'إدارة مناطق الشحن والمدن ونطاقات الرمز البريدي والمناطق المحظورة',
    'total_regions' => 'إجمالي المناطق',
    'total_cities' => 'إجمالي المدن',
    'active_cities' => 'المدن النشطة',
    'blocked_ranges' => 'النطاقات المحظورة',
    'regions' => 'المناطق',
    'cities' => 'المدن',
    'settings' => 'الإعدادات',
    'shipping_regions' => 'مناطق الشحن',
    'shipping_cities' => 'مدن الشحن',
    'shipping_blocked_ranges' => 'نطاقات البريد المحظورة',
    'shipping_settings' => 'إعدادات الشحن',
    'add_region' => 'إضافة منطقة',
    'add_city' => 'إضافة مدينة',
    'add_blocked_range' => 'إضافة نطاق محظور',
    'edit_region' => 'تعديل المنطقة',
    'edit_city' => 'تعديل المدينة',
    'edit_blocked_range' => 'تعديل النطاق المحظور',
    'region' => 'المنطقة',
    'key' => 'المفتاح',
    'name' => 'الاسم',
    ...
    'actions' => 'الإجراءات',
    'status' => 'الحالة',
    'postal_range' => 'نطاق البريد',
    'postal_code_min' => 'أدنى رمز بريدي',
    'postal_code_max' => 'أعلى رمز بريدي',
    'postal_range_preview' => 'معاينة نطاق البريد',
    'label' => 'التسمية',
    'reason' => 'السبب',
    'confirm_delete' => 'هل أنت متأكد من حذف هذا العنصر؟',
    'no_regions_found' => 'لم يتم العثور على مناطق شحن',
    'no_cities_in_region' => 'لا توجد مدن في هذه المنطقة',
    'no_blocked_ranges' => 'لا توجد نطاقات بريدية محظورة',
    'shipping_region_created' => 'تم إنشاء منطقة الشحن بنجاح',
    'shipping_region_updated' => 'تم تحديث منطقة الشحن بنجاح',
    'shipping_region_deleted' => 'تم حذف منطقة الشحن بنجاح',
    'shipping_region_has_cities' => 'لا يمكن حذف منطقة تحتوي على مدن. قم بإزالة المدن أولاً.',
    'shipping_city_created' => 'تم إنشاء مدينة الشحن بنجاح',
    'shipping_city_updated' => 'تم تحديث مدينة الشحن بنجاح',
    'shipping_city_deleted' => 'تم حذف مدينة الشحن بنجاح',
    'shipping_postal_range_overlap' => 'نطاق الرمز البريدي يتداخل مع مدينة موجودة في هذه المنطقة',
    'shipping_blocked_range_created' => 'تم إنشاء النطاق المحظور بنجاح',
    'shipping_blocked_range_updated' => 'تم تحديث النطاق المحظور بنجاح',
    'shipping_blocked_range_deleted' => 'تم حذف النطاق المحظور بنجاح',
    'shipping_settings_updated' => 'تم تحديث إعدادات الشحن بنجاح',
    'shipping_region_activated' => 'تم تفعيل المنطقة',
    'shipping_region_deactivated' => 'تم تعطيل المنطقة',
    'shipping_city_activated' => 'تم تفعيل المدينة',
    'shipping_city_deactivated' => 'تم تعطيل المدينة',
    'shipping_blocked_range_activated' => 'تم تفعيل النطاق المحظور',
    'shipping_blocked_range_deactivated' => 'تم تعطيل النطاق المحظور',
    'shipping_country_label' => 'دولة الشحن',
    'shipping_country_desc' => 'الدولة الثابتة لجميع عناوين الشحن',
    'postal_digits_label' => 'أرقام الرمز البريدي',
    'postal_digits_desc' => 'عدد الأرقام بعد البادئة P',
    'free_shipping_threshold_label' => 'حد الشحن المجاني',
    'free_shipping_threshold_desc' => 'شحن مجاني للطلبات فوق هذا المبلغ',
    'shipping_fee_label' => 'رسوم الشحن الافتراضية',
    'shipping_fee_desc' => 'تكلفة الشحن عندما يكون الطلب أقل من حد الشحن المجاني',
    'shipping_enabled_label' => 'تفعيل الشحن',
    'shipping_enabled_desc' => 'تفعيل أو تعطيل نظام الشحن',
    'save_settings' => 'حفظ الإعدادات',
    'find_your_postal_code' => 'للحصول على الرمز البريدي لموقعك',
    ...
    'cancel_order' => "\xD8\xA5\xD9\x84\xD8\xBA\xD8\xA7\xD8\xA1 \xD8\xA7\xD9\x84\xD8\xB7\xD9\x84\xD8\xA8",
    'total_items' => "\xD8\xB9\xD8\xAF\xD8\xAF \xD8\xA7\xD9\x84\xD9\x85\xD9\x86\xD8\xAA\xD8\xAC\xD8\xA7\xD8\xAA",
    'why_cancel_order' => "\xD9\x84\xD9\x85\xD8\xA7\xD8\xB0\xD8\xA7 \xD8\xAA\xD8\xB1\xD9\x8A\xD8\xAF \xD8\xA5\xD9\x84\xD8\xBA\xD8\xA7\xD8\xA1 \xD9\x87\xD8\xB0\xD8\xA7 \xD8\xA7\xD9\x84\xD8\xB7\xD9\x84\xD8\xA8\xD8\x9F",
    'ordered_by_mistake' => "\xD8\xB7\xD9\x84\xD8\xA8 \xD8\xB9\xD9\x86 \xD8\xB7\xD8\xB1\xD9\x8A\xD9\x82 \xD8\xA7\xD9\x84\xD8\xAE\xD8\xB7\xD8\xA3",
    'external_url' => 'رابط خارجي',
    'external_url_desc' => 'استخدام رابط صورة من الإنترنت',
    'download_from_url' => 'تحميل من رابط',
    'download_from_url_desc' => 'تحميل الصورة من الرابط وتخزينها على السيرفر',
    'stored_on_server' => 'مخزنة على السيرفر',
    'keep_current' => 'الاحتفاظ بالحالية',
    'keep_current_desc' => 'بدون تغيير على الصورة',
    'keep_current_info' => 'سيتم الاحتفاظ بالصورة الحالية. اختر خياراً آخر أعلاه لتغييرها.',
    ...
    'file_storage_info' => 'سيتم تخزين الصورة على نظام ملفات السيرفر لأداء مثالي.',
    'database_storage_info' => 'سيتم تخزين الصورة مباشرة في قاعدة البيانات. الحد الأقصى: :max_size',
    'url_storage_info' => 'سيتم تحميل الصورة مباشرة من الرابط الخارجي. تأكد من أن الرابط متاح دائماً.',
    'download_url_storage_info' => 'سيتم تحميل الصورة من الرابط وتخزينها على السيرفر لأداء مثالي.',
    'image_load_failed' => 'فشل تحميل الصورة. يرجى التحقق من الرابط.',
    'failed_to_download_image' => 'فشل تحميل الصورة من الرابط المقدم.',
    ...
    // Home Page Sections Management - إدارة أقسام الصفحة الرئيسية
    'home_sections_management' => 'أقسام الصفحة الرئيسية',
    'home_sections_subtitle' => 'إدارة وترتيب الأقسام المعروضة في الصفحة الرئيسية',
    'add_section' => 'إضافة قسم',
    'add_section_subtitle' => 'إضافة قسم جديد إلى الصفحة الرئيسية',
    'edit_section' => 'تعديل القسم',
    'edit_section_subtitle' => 'تحديث إعدادات ومحتوى القسم',
    ...
    'display_order' => 'ترتيب العرض',
    'display_order_help' => 'الأرقام الأقل تظهر أولاً في الصفحة الرئيسية',
    'section_active_help' => 'فقط الأقسام النشطة تظهر في الصفحة الرئيسية',
    'drag_to_reorder' => 'اسحب لإعادة ترتيب الأقسام',
    'reorder_unsaved' => 'لديك تغييرات ترتيب غير محفوظة',
    'save_order' => 'حفظ الترتيب',
    'saving' => 'جاري الحفظ...',
    'sections_reordered' => 'تم حفظ ترتيب الأقسام بنجاح!',
    'section_activated' => 'تم تفعيل القسم',
    'section_deactivated' => 'تم إلغاء تفعيل القسم',
    ...
    'all_section_types_in_use' => 'جميع أنواع الأقسام مستخدمة بالفعل. يمكنك فقط إضافة أقسام محتوى مخصص.',
    'save_section' => 'حفظ القسم',
    'update_section' => 'تحديث القسم',
    'delete_section_confirm' => 'هل أنت متأكد أنك تريد حذف هذا القسم؟ هذا الإجراء لا يمكن التراجع عنه.',
    'no_sections_found' => 'لا توجد أقسام',
    'no_sections_description' => 'لم يتم إنشاء أي أقسام للصفحة الرئيسية بعد. أضف قسماً للبدء!',
    'advanced_settings' => 'إعدادات متقدمة',
    'max_products' => 'الحد الأقصى للمنتجات',
    'max_products_help' => 'الحد الأقصى لعدد المنتجات المعروضة في هذا القسم',
    'cards_to_scroll' => 'عدد البطاقات للتمرير',
    'cards_to_scroll_help' => 'عدد البطاقات التي يتم تمريرها في كل مرة',
    'auto_scroll_interval' => 'فترة التمرير التلقائي (مللي ثانية)',
    'auto_scroll_interval_help' => 'الوقت بالمللي ثانية بين كل تمرير تلقائي',
    'background_color' => 'لون الخلفية',
    'background_color_help' => 'لون خلفية اختياري لهذا القسم (مثال: #ffffff)',
    'subtitle' => 'العنوان الفرعي',
    'custom_html_content' => 'محتوى HTML مخصص',
    'custom_html' => 'HTML مخصص',

    // Section Type Labels - أنواع الأقسام
    'section_type_hero_banner' => 'سلايدر البانر الرئيسي',
    'section_type_category_carousel' => 'عرض الفئات الدوار',
    'section_type_featured_products' => 'المنتجات المميزة',
    'section_type_special_offers_banner' => 'بانر العروض الخاصة',
    'section_type_special_discounts' => 'الخصومات الخاصة',
    'section_type_new_arrivals' => 'وصل حديثاً',
    'section_type_bestsellers' => 'الأكثر مبيعاً',
    'section_type_gift_ideas_banner' => 'بانر أفكار الهدايا',
    'section_type_on_sale' => 'منتجات التخفيضات',
    'section_type_custom_content' => 'محتوى مخصص',
    'section_type_custom_product_section' => 'قسم منتجات مخصص',

    // Product Home Section Assignment - تعيين أقسام الصفحة الرئيسية للمنتج
    'built_in_section' => 'مدمج',
    'home_page_sections' => 'أقسام الصفحة الرئيسية',
    'select_sections_for_product' => 'اختر الأقسام المخصصة التي يجب أن يظهر فيها هذا المنتج في الصفحة الرئيسية',
    'hold_ctrl_to_select_multiple' => 'اضغط Ctrl (أو Cmd) لاختيار أكثر من قسم',

    // رفع صور المنتج
    'upload_files' => 'رفع ملفات',
    'upload_from_device' => 'رفع الصور من جهازك (تُخزن على السيرفر)',
    'image_url' => 'رابط الصورة',
    'paste_external_url' => 'لصق روابط صور خارجية',
    'leave_empty_to_keep' => 'اتركه فارغاً للاحتفاظ بالصورة الحالية',
    'optional_on_edit' => 'اختياري - اتركه فارغاً للاحتفاظ بالصورة الحالية',
    'accepted_formats' => 'الصيغ المقبولة: JPG، PNG، WebP. الحد الأقصى: :max_size',
    'max_10_files' => '10 ملفات كحد أقصى',
    'select_multiple_images' => 'اختر عدة صور. كل صورة بحد أقصى :max_size.',
    ...
    'or_click_to_browse' => 'أو انقر لاستعراض الملفات',
    'files_selected' => 'ملف(ات) محددة',
    'click_to_change' => 'انقر لتغيير الاختيار',
    'remove' => 'إزالة',

    // إعدادات الموقع
    'site_settings' => 'إعدادات الموقع',
    'manage_site_configuration' => 'إدارة إعدادات وتفضيلات الموقع',
    'image_settings' => 'إعدادات الصور',
    'image_settings_description' => 'تكوين حدود رفع الصور والجودة وإعدادات التنسيق. تنطبق هذه الإعدادات على جميع عمليات رفع الصور في لوحة الإدارة.',
    'image_settings_updated' => 'تم تحديث إعدادات الصور بنجاح.',
    'max_image_size' => 'الحد الأقصى لحجم الصورة',
    'allowed_formats' => 'الصيغ المسموحة',
    'comma_separated_formats' => 'قائمة امتدادات الملفات المسموحة مفصولة بفواصل',
    'max_additional_images_setting' => 'الحد الأقصى للصور الإضافية',
    'image_quality' => 'جودة الصورة',
    'quality_hint' => 'أعلى = جودة أفضل، حجم أكبر. الموصى به: 70-85%',
    'max_image_width' => 'الحد الأقصى لعرض الصورة',
    'max_image_height' => 'الحد الأقصى لارتفاع الصورة',
    'convert_to_webp' => 'تحويل إلى WebP',
    'webp_description' => 'تحويل الصور المرفوعة تلقائياً إلى صيغة WebP لأحجام ملفات أصغر وتحميل أسرع',
    'save_settings' => 'حفظ الإعدادات',
    ...
    // تغيير كلمة المرور
    'change_password' => 'تغيير كلمة المرور',
    'password_change_description' => 'قم بتحديث كلمة مرور حساب المسؤول. تأكد من استخدام كلمة مرور قوية لا تستخدمها في مكان آخر.',
    'current_password' => 'كلمة المرور الحالية',
    'new_password' => 'كلمة المرور الجديدة',
    'confirm_new_password' => 'تأكيد كلمة المرور الجديدة',
    'update_password' => 'تحديث كلمة المرور',
    ...
    'refund_policy_page_title' => 'سياسة الاسترداد والإرجاع',
    'refund_policy_subtitle' => 'سياساتنا المتعلقة بالإرجاع والاستبدال والاسترداد',
    'refund_policy_tab' => 'سياسة الاسترداد',
    'policy_content_coming_soon' => 'محتوى السياسة قيد الإعداد. يرجى التحقق مرة أخرى قريباً.',
    'privacy_policy_admin_description' => 'إدارة محتوى سياسة الخصوصية المعروض في صفحة سياسة الخصوصية العامة. يمكنك كتابة محتوى HTML لكل لغة.',
    'refund_policy_admin_description' => 'إدارة محتوى سياسة الاسترداد والإرجاع المعروض في صفحة سياسة الاسترداد العامة. يمكنك كتابة محتوى HTML لكل لغة.',
    'policy_content_english' => 'المحتوى (الإنجليزية)',
    'policy_content_arabic' => 'المحتوى (العربية)',
    'policy_content_hebrew' => 'المحتوى (العبرية)',
    'policy_html_placeholder' => '<h2>عنوان القسم</h2>\n<p>نص السياسة هنا...</p>',
    'policy_html_hint' => 'يمكنك استخدام وسوم HTML مثل <h2> و <h3> و <p> و <ul> و <li> و <strong> لتنسيق المحتوى.',
    'save_privacy_policy' => 'حفظ سياسة الخصوصية',
    'save_refund_policy' => 'حفظ سياسة الاسترداد',
    'privacy_policy_updated' => 'تم تحديث سياسة الخصوصية بنجاح.',
    'refund_policy_updated' => 'تم تحديث سياسة الاسترداد بنجاح.',

    'social_links' => 'روابط التواصل الاجتماعي',
    'social_links_admin_description' => 'إدارة أيقونات التواصل الاجتماعي المعروضة على الموقع. يمكنك الإضافة والتعديل والإخفاء والحذف.',
    'social_links_updated' => 'تم تحديث روابط التواصل الاجتماعي بنجاح.',
    'add_social_platform' => 'إضافة منصة',
    'save_social_links' => 'حفظ الروابط',
    'choose_platform' => 'اختر منصة',
    'or_custom_platform' => 'أو أضف منصة مخصصة',
    'platform_name' => 'اسم المنصة',
    'platform_icon' => 'كلاس أيقونة Font Awesome',
    'add_custom' => 'إضافة مخصص',
    'platform_name_required' => 'يرجى إدخال اسم المنصة.',
    ...
    // Site Logo
    'site_logo_tab' => 'شعار الموقع',
    'site_logo_description' => 'قم بتحميل شعار مخصص يظهر في رأس الموقع والتنقل في الجوال والتذييل. الصيغ المدعومة: PNG, JPG, WebP, SVG. الحد الأقصى: 2 ميجابايت. موصى به: خلفية شفافة، بحد أقصى 500×200 بكسل.',
    'logo_upload' => 'تحميل الشعار',
    'logo_change' => 'تغيير الشعار',
    'logo_save' => 'حفظ الشعار',
    'logo_delete' => 'إزالة الشعار',
    'logo_delete_hint' => 'سيؤدي هذا إلى العودة إلى شعار الموقع الافتراضي.',
    'logo_delete_confirm' => 'هل أنت متأكد من أنك تريد إزالة الشعار المخصص؟ سيعود الموقع إلى الشعار الافتراضي.',
    'logo_updated' => 'تم تحديث شعار الموقع بنجاح.',
    'logo_deleted' => 'تم إزالة الشعار المخصص. استخدام الشعار الافتراضي.',
    'logo_custom_active' => 'الشعار المخصص نشط',
    'logo_using_default' => 'استخدام الشعار الافتراضي',
    'logo_allowed_formats' => 'PNG, JPG, WebP, أو SVG (بحد أقصى 2 ميجابايت)',

    // Site Icon / Favicon
    'site_icon' => 'أيقونة الموقع',
    'site_icon_description' => 'قم بتحميل أيقونة مخصصة للموقع تظهر في علامات تبويب المتصفح والإشارات المرجعية وشاشات الهاتف الرئيسية. الصيغ المدعومة: PNG, JPG, WebP, ICO. الحد الأقصى: 512 كيلوبايت.',
    'favicon_upload' => 'تحميل الأيقونة',
    'favicon_change' => 'تغيير الأيقونة',
    'favicon_save' => 'حفظ الأيقونة',
    'favicon_delete' => 'إزالة الأيقونة',
    'favicon_delete_hint' => 'سيتم العودة إلى أيقونة الموقع الافتراضية.',
    'favicon_delete_confirm' => 'هل أنت متأكد من إزالة الأيقونة المخصصة؟ سيعود الموقع إلى الأيقونة الافتراضية.',
    'favicon_updated' => 'تم تحديث أيقونة الموقع بنجاح.',
    'favicon_deleted' => 'تمت إزالة الأيقونة المخصصة. يتم استخدام الأيقونة الافتراضية.',
    'favicon_custom_active' => 'الأيقونة المخصصة مفعلة',
    'favicon_using_default' => 'يتم استخدام الأيقونة الافتراضية',
    'favicon_allowed_formats' => 'PNG, JPG, WebP, أو ICO (الحد الأقصى 512 كيلوبايت)',
    'favicon_required' => 'يرجى اختيار ملف أيقونة للتحميل.',
    'favicon_must_be_file' => 'يجب أن تكون الأيقونة ملفًا صالحًا.',
    'favicon_max_size' => 'يجب ألا يتجاوز حجم الأيقونة :size كيلوبايت.',
    'favicon_invalid_type' => 'نوع الملف غير صالح. الصيغ المسموحة: PNG, JPG, WebP, ICO.',
    'favicon_invalid_image' => 'لا يبدو أن الملف صورة صالحة.',
    'favicon_dangerous_content' => 'تم رفض الملف لأسباب أمنية.',
    'favicon_upload_failed' => 'فشل تحميل الأيقونة. يرجى المحاولة مرة أخرى.',
