...
return [
    ...
    'review_requires_purchase_shipped' => 'You must purchase and receive this product before you can review it.',
    ...
    'shipping_palestine_only' => 'We currently ship only within Palestine (West Bank and 1948 Territories). Gaza shipping is not available at this time.',
    'shipping_country_locked' => 'Shipping to Palestine only',
    'postal_code_mismatch' => 'Postal code does not match selected city. Valid range: :min – :max',
    'postal_code_valid' => 'Postal code is valid',
    'postal_hint_range' => 'Valid range: :min – :max',
    'city_selected_success' => 'City selected',
    'select_city_first' => 'Please select a city first',
    'invalid_postal_format' => 'Postal code must start with P followed by :digits digits (e.g. P5840719)',
    'no_shipping_to_gaza' => 'Sorry, shipping to Gaza is not available at this time',
    'invalid_city_selected' => 'The selected city is not valid for shipping',
    'please_login_to_checkout' => 'Please login to proceed to checkout',
    'must_login_to_place_order' => 'You must be logged in to place an order',
    'deleted_products_removed_from_cart' => 'Some products were removed from your cart because they are no longer available',

    // Admin Shipping Management
    'shipping_management' => 'Shipping Management',
    'shipping_management_subtitle' => 'Manage shipping regions, cities, postal code ranges, and blocked areas',
    'total_regions' => 'Total Regions',
    'total_cities' => 'Total Cities',
    'active_cities' => 'Active Cities',
    'blocked_ranges' => 'Blocked Ranges',
    'regions' => 'Regions',
    'cities' => 'Cities',
    'settings' => 'Settings',
    'shipping_regions' => 'Shipping Regions',
    'shipping_cities' => 'Shipping Cities',
    'shipping_blocked_ranges' => 'Blocked Postal Ranges',
    'shipping_settings' => 'Shipping Settings',
    'add_region' => 'Add Region',
    'add_city' => 'Add City',
    'add_blocked_range' => 'Add Blocked Range',
    'edit_region' => 'Edit Region',
    'edit_city' => 'Edit City',
    'edit_blocked_range' => 'Edit Blocked Range',
    'region' => 'Region',
    'key' => 'Key',
    'name' => 'Name',
    ...
    'actions' => 'Actions',
    'status' => 'Status',
    'postal_range' => 'Postal Range',
    'postal_code_min' => 'Postal Code Min',
    'postal_code_max' => 'Postal Code Max',
    'postal_range_preview' => 'Postal Range Preview',
    'label' => 'Label',
    'reason' => 'Reason',
    'confirm_delete' => 'Are you sure you want to delete this item?',
    'no_regions_found' => 'No shipping regions found',
    'no_cities_in_region' => 'No cities in this region',
    'no_blocked_ranges' => 'No blocked postal ranges',
    'shipping_region_created' => 'Shipping region created successfully',
    'shipping_region_updated' => 'Shipping region updated successfully',
    'shipping_region_deleted' => 'Shipping region deleted successfully',
    'shipping_region_has_cities' => 'Cannot delete region that has cities. Remove cities first.',
    'shipping_city_created' => 'Shipping city created successfully',
    'shipping_city_updated' => 'Shipping city updated successfully',
    'shipping_city_deleted' => 'Shipping city deleted successfully',
    'shipping_postal_range_overlap' => 'Postal code range overlaps with an existing city in this region',
    'shipping_blocked_range_created' => 'Blocked range created successfully',
    'shipping_blocked_range_updated' => 'Blocked range updated successfully',
    'shipping_blocked_range_deleted' => 'Blocked range deleted successfully',
    'shipping_settings_updated' => 'Shipping settings updated successfully',
    'shipping_region_activated' => 'Region activated',
    'shipping_region_deactivated' => 'Region deactivated',
    'shipping_city_activated' => 'City activated',
    'shipping_city_deactivated' => 'City deactivated',
    'shipping_blocked_range_activated' => 'Blocked range activated',
    'shipping_blocked_range_deactivated' => 'Blocked range deactivated',
    'shipping_country_label' => 'Shipping Country',
    'shipping_country_desc' => 'The fixed country for all shipping addresses',
    'postal_digits_label' => 'Postal Code Digits',
    'postal_digits_desc' => 'Number of digits after the P prefix',
    'free_shipping_threshold_label' => 'Free Shipping Threshold',
    'free_shipping_threshold_desc' => 'Free shipping for orders above this amount',
    'shipping_fee_label' => 'Default Shipping Fee',
    'shipping_fee_desc' => 'Shipping cost when order is below the free threshold',
    'shipping_enabled_label' => 'Shipping Enabled',
    'shipping_enabled_desc' => 'Enable or disable the shipping system',
    'save_settings' => 'Save Settings',
    'find_your_postal_code' => 'Find your postal code',
    ...
    'danger_zone_product' => 'Danger Zone',
    'delete_product_warning' => 'Deleting this product will permanently remove it from your store. This action cannot be undone.',
    'show_special_offer_homepage' => 'Show as special offer card on homepage',
    'category' => 'Category',
    'brand' => 'Brand',
    ...
    'enter_image_url_per_line' => 'Enter each image URL on a new line for the product gallery',
    'short_description_english' => 'Short Description (English)',
    'short_description_arabic' => 'Short Description (Arabic)',
    'brief_description_listings' => 'Brief description for product listings',
    'full_description_english' => 'Full Description (English)',
    ...
    'why_cancel_order' => 'Why are you cancelling this order?',
    'ordered_by_mistake' => 'Ordered by mistake',
    'found_better_price' => 'Found a better price',
    'delivery_too_long' => 'Delivery time too long',
    'payment_issue' => 'Payment issue',
    'other_reason' => 'Other',
    'please_specify_reason' => 'Please specify your reason...',
    'no_payment_charged' => 'No payment has been charged.',
    'refund_processed_days' => 'Your refund will be processed to your original payment method within 3-5 business days.',
    ...
    'Set how often automatic backups should be created' => 'Set how often automatic backups should be created',
    'Disabled' => 'Disabled',
    ...
    'Cleanup Expired Backups' => 'Cleanup Expired Backups',
    'Delete all backups that have exceeded their retention period or are invalid' => 'Delete all backups that have exceeded their retention period or are invalid.',
    'Are you sure you want to delete all expired backups?' => 'Are you sure you want to delete all expired backups?',
    'Delete Expired Backups Now' => 'Delete Expired Backups Now',
    'No expired backups found' => 'No expired backups found.',
    'Expired backups cleaned up successfully' => ':count expired backup(s) deleted successfully!',
    'Failed to delete count backups' => 'Failed to delete :count backup(s)',
    'Failed to cleanup expired backups' => 'Failed to cleanup expired backups.',
    ...
    'banner_upload_from_device_desc' => 'Upload image file and store on server',
    'external_url' => 'External URL',
    'external_url_desc' => 'Use image URL from the internet',
    'download_from_url' => 'Download from URL',
    'download_from_url_desc' => 'Download image from URL and store on server',
    'stored_on_server' => 'Stored on Server',
    'keep_current' => 'Keep Current',
    'keep_current_desc' => 'No changes to image',
    'keep_current_info' => 'The current image will be kept. Select another option above to change it.',
    ...
    'file_storage_info' => 'Image will be stored on the server filesystem for optimal performance.',
    'database_storage_info' => 'Image will be stored directly in the database. Max size: :max_size',
    'url_storage_info' => 'Image will be loaded directly from external URL. Make sure the URL is always accessible.',
    'download_url_storage_info' => 'Image will be downloaded from the URL and stored on the server for optimal performance.',
    'image_load_failed' => 'Failed to load image. Please check the URL.',
    'failed_to_download_image' => 'Failed to download image from the provided URL.',
    ...
    'title_arabic' => 'Title (Arabic)',
    'title_hebrew' => 'Title (Hebrew)',
    'title_english_placeholder' => 'Enter title in English',
    'title_arabic_placeholder' => 'Enter title in Arabic',
    'title_hebrew_placeholder' => 'Enter title in Hebrew',
    'title_color' => 'Title Color',
    'title_font_size' => 'Title Font Size',
    'subtitle_english' => 'Subtitle (English)',
    'subtitle_arabic' => 'Subtitle (Arabic)',
    'subtitle_hebrew' => 'Subtitle (Hebrew)',
    'subtitle_english_placeholder' => 'Enter subtitle in English',
    'subtitle_arabic_placeholder' => 'Enter subtitle in Arabic',
    'subtitle_hebrew_placeholder' => 'Enter subtitle in Hebrew',
    'subtitle_color' => 'Subtitle Color',
    'subtitle_font_size' => 'Subtitle Font Size',
    'button_text_english' => 'Button Text (English)',
    'button_text_arabic' => 'Button Text (Arabic)',
    'button_text_hebrew' => 'Button Text (Hebrew)',
    'button_text_english_placeholder' => 'e.g., Shop Now',
    'button_text_arabic_placeholder' => 'e.g., تسوق الآن',
    'button_text_hebrew_placeholder' => 'e.g., קנה עכשיו',
    ...
    'no_tags_description' => 'You haven\'t created any tags yet. Start by creating your first tag!',
    'create_first_tag' => 'Create First Tag',
    'confirm_delete_tag' => 'Are you sure you want to delete this tag?',
    'create_tag' => 'Create Tag',
    'create_new_tag' => 'Create New Tag',
    'add_tag_subtitle' => 'Add a new tag to categorize products',
    'back_to_tags' => 'Back to Tags',
    'tag_information' => 'Tag Information',
    'tag_name_english' => 'Tag Name (English)',
    'tag_name_arabic' => 'Tag Name (Arabic)',
    'tag_color' => 'Tag Color',
    'tag_color_help' => 'Choose a color for the tag badge',
    'tag_icon' => 'Tag Icon',
    'display_tag_in_store' => 'Display this tag in the store',
    'create_tag_button' => 'Create Tag',
    'edit_tag' => 'Edit Tag',
    'update_tag_information' => 'Update tag information',
    ...
    'tags_help' => 'Select appropriate tags for the product (e.g., Gaming, Office, Student)',
    'type_to_search_or_add_tag' => 'Type to search or add a new tag...',
    'tag_input_help' => 'Type to search existing tags or press Enter to add a new tag',
    ...
    'CRITICAL DANGER ZONE' => 'CRITICAL DANGER ZONE',
    'This action will permanently delete ALL data from the database' => 'This action will permanently delete ALL data from the database',
    'What will be deleted:' => 'What will be deleted:',
    'All products and their images' => 'All products and their images',
    'All categories and brands' => 'All categories and brands',
    'All orders and order history' => 'All orders and order history',
    'All customer accounts' => 'All customer accounts',
    'All reviews and ratings' => 'All reviews and ratings',
    'All banners and promotional content' => 'All banners and promotional content',
    'All other data in the system' => 'All other data in the system',
    'What will be preserved:' => 'What will be preserved:',
    'Your admin account only' => 'Your admin account only',
    'Security Verification' => 'Security Verification',
    'Type' => 'Type',
    'to confirm:' => 'to confirm:',
    'Type DELETE ALL DATA' => 'Type DELETE ALL DATA',
    'Enter your admin password:' => 'Enter your admin password:',
    'Your password' => 'Your password',
    'I understand this action is IRREVERSIBLE and all data will be permanently lost' => 'I understand this action is IRREVERSIBLE and all data will be permanently lost',
    'DELETE ALL DATA' => 'DELETE ALL DATA',
    'Please type DELETE ALL DATA to confirm' => 'Please type DELETE ALL DATA to confirm',
    'Deleting...' => 'Deleting...',
    'All data has been deleted successfully' => 'All data has been deleted successfully',
    'Failed to purge data' => 'Failed to purge data',
    ...
    'specification_templates' => 'Specification Templates',
    'manage_category_spec_templates' => 'Manage category-based product specification templates',
    ...
    'edit' => 'Edit',
    'delete' => 'Delete',
    'confirm_delete_template' => 'Are you sure you want to delete this template? This will remove all specification values from products in this category.',
    'no_templates_found' => 'No specification templates found',
    'create_first_template' => 'Create your first template to define product specifications for a category.',
    'select_category' => 'Select a category',
    'category_template_unique' => 'Each category can only have one specification template.',
    'template_active_desc' => 'Active templates will show specification fields when editing products.',
    'create_and_add_fields' => 'Create & Add Fields',
    'cancel' => 'Cancel',
    'all_categories_have_templates' => 'All categories have templates',
    'all_categories_assigned' => 'All active categories have been assigned specification templates.',
    'create_new_category' => 'Create New Category',
    'create_spec_template_desc' => 'Create a specification template for a category to define product specification fields.',
    'category_already_has_template' => 'This category already has a specification template.',
    'category_required' => 'Category is required.',
    'template_name_required' => 'Template name is required.',
    'template_created_successfully' => 'Template created successfully! Add fields below.',
    'template_updated_successfully' => 'Template updated successfully.',
    'template_deleted_successfully' => 'Template deleted successfully.',
    'back' => 'Back',
    'save_changes' => 'Save Changes',
    'specification_fields' => 'Specification Fields',
    'drag_to_reorder' => 'Drag to reorder fields',
    'no_fields_added' => 'No fields have been added to this template yet.',
    'add_new_field' => 'Add New Field',
    'field_label' => 'Field Label',
    'field_key' => 'Field Key',
    'field_key_help' => 'Lowercase letters, numbers and underscores only. Auto-generated if empty.',
    ...
    'required' => 'Required',
    'options' => 'Options',
    'options_help' => 'Enter one option per line. Only used for Select type.',
    'add_field' => 'Add Field',
    'edit_field' => 'Edit Field',
    'confirm_delete_field' => 'Are you sure you want to delete this field? This will remove all saved values for this field from products.',
    ...
    'delete_template_warning' => 'Deleting this template will permanently remove all specification fields and saved product values.',
    'key_must_be_lowercase' => 'Key must start with a lowercase letter and contain only lowercase letters, numbers, and underscores.',
    'key_already_exists_in_template' => 'This key already exists in this template.',
    ...
    'no_specifications_available' => 'No specifications available for this product.',
    'spec_field_required' => 'The :field field is required.',
    ...
    'home_sections_management' => 'Home Page Sections',
    'home_sections_subtitle' => 'Manage and reorder the sections displayed on the home page',
    'add_section' => 'Add Section',
    'add_section_subtitle' => 'Add a new section to the home page',
    'edit_section' => 'Edit Section',
    'edit_section_subtitle' => 'Update the section settings and content',
    ...
    'display_order' => 'Display Order',
    'display_order_help' => 'Lower numbers appear first on the home page',
    'section_active_help' => 'Only active sections are displayed on the home page',
    'drag_to_reorder' => 'Drag to reorder sections',
    'reorder_unsaved' => 'You have unsaved order changes',
    'save_order' => 'Save Order',
    'saving' => 'Saving...',
    'sections_reordered' => 'Section order saved successfully!',
    'section_activated' => 'Section activated',
    'section_deactivated' => 'Section deactivated',
    'home_section_created' => 'Section created successfully!',
    'home_section_updated' => 'Section updated successfully!',
    'home_section_deleted' => 'Section deleted successfully!',
    'all_section_types_in_use' => 'All section types are already in use. You can only add custom content sections.',
    ...
    'no_sections_description' => 'No home page sections have been created yet. Add a section to get started!',
    'advanced_settings' => 'Advanced Settings',
    'max_products' => 'Max Products',
    'max_products_help' => 'Maximum number of products to display in this section',
    'cards_to_scroll' => 'Cards to Scroll',
    'cards_to_scroll_help' => 'Number of cards to scroll at a time in the scroller',
    'auto_scroll_interval' => 'Auto Scroll Interval (ms)',
    'auto_scroll_interval_help' => 'Time in milliseconds between auto-scroll transitions',
    'background_color' => 'Background Color',
    'background_color_help' => 'Optional background color for this section (e.g. #ffffff)',
    'subtitle' => 'Subtitle',
    'custom_html_content' => 'Custom HTML Content',
    'custom_html' => 'Custom HTML',

    // Section Type Labels
    'section_type_hero_banner' => 'Hero Banner Slider',
    'section_type_category_carousel' => 'Category Carousel',
    'section_type_featured_products' => 'Featured Products',
    'section_type_special_offers_banner' => 'Special Offers Banner',
    'section_type_special_discounts' => 'Special Discounts',
    'section_type_new_arrivals' => 'New Arrivals',
    'section_type_bestsellers' => 'Bestsellers',
    'section_type_gift_ideas_banner' => 'Gift Ideas Banner',
    'section_type_on_sale' => 'On Sale Products',
    'section_type_custom_content' => 'Custom Content',
    'section_type_custom_product_section' => 'Custom Product Section',

    // Product Home Section Assignment
    'built_in_section' => 'Built-in',
    'home_page_sections' => 'Home Page Sections',
    'select_sections_for_product' => 'Select which custom sections this product should appear in on the home page',
    'hold_ctrl_to_select_multiple' => 'Hold Ctrl (or Cmd) to select multiple sections',

    // Product Image Upload
    'upload_files' => 'Upload Files',
    'upload_from_device' => 'Upload images from your device (stored on server)',
    'image_url' => 'Image URL',
    'paste_external_url' => 'Paste external image URLs',
    'leave_empty_to_keep' => 'Leave empty to keep the current image',
    'optional_on_edit' => 'Optional - leave empty to keep current',
    'accepted_formats' => 'Accepted: JPG, PNG, WebP. Max size: :max_size',
    'max_10_files' => 'Max 10 files',
    'select_multiple_images' => 'Select multiple images. Each max :max_size.',
    'image_upload_failed' => 'Image upload failed. Please try again.',

    // Dropzone UI
    'drag_drop_image' => 'Drag & drop your image here',
    'drag_drop_images' => 'Drag & drop your images here',
    'or_click_to_browse' => 'or click to browse files',
    'files_selected' => 'file(s) selected',
    'click_to_change' => 'Click to change selection',
    'remove' => 'Remove',
    ...
    'image_settings_description' => 'Configure image upload limits, quality, and format settings. These settings apply to all image uploads across the admin panel.',
    'image_settings_updated' => 'Image settings updated successfully.',
    'max_image_size' => 'Maximum Image Size',
    'allowed_formats' => 'Allowed Formats',
    'comma_separated_formats' => 'Comma-separated list of allowed file extensions',
    'max_additional_images_setting' => 'Max Additional Images',
    'image_quality' => 'Image Quality',
    'quality_hint' => 'Higher = better quality, larger file. Recommended: 70-85%',
    'max_image_width' => 'Max Image Width',
    'max_image_height' => 'Max Image Height',
    'convert_to_webp' => 'Convert to WebP',
    'webp_description' => 'Automatically convert uploaded images to WebP format for smaller file sizes and faster loading',
    'save_settings' => 'Save Settings',
    ...
    // Change Password
    'change_password' => 'Change Password',
    'password_change_description' => 'Update your admin account password. Make sure to use a strong password that you don\'t use elsewhere.',
    'current_password' => 'Current Password',
    'new_password' => 'New Password',
    'confirm_new_password' => 'Confirm New Password',
    'update_password' => 'Update Password',
    ...
    'password_min_8' => 'At least 8 characters long',
    ...
    'refund_policy_page_title' => 'Refund & Return Policy',
    'refund_policy_subtitle' => 'Our policies regarding returns, exchanges, and refunds',
    'refund_policy_tab' => 'Refund Policy',
    'policy_content_coming_soon' => 'Policy content is being prepared. Please check back soon.',
    'privacy_policy_admin_description' => 'Manage the privacy policy content displayed on the public privacy policy page. You can write HTML content for each language.',
    'refund_policy_admin_description' => 'Manage the refund & return policy content displayed on the public refund policy page. You can write HTML content for each language.',
    'policy_content_english' => 'Content (English)',
    'policy_content_arabic' => 'Content (Arabic)',
    'policy_content_hebrew' => 'Content (Hebrew)',
    'policy_html_placeholder' => '<h2>Section Title</h2>\n<p>Your policy text here...</p>',
    'policy_html_hint' => 'You can use HTML tags like <h2>, <h3>, <p>, <ul>, <li>, <strong> to format the content.',
    'save_privacy_policy' => 'Save Privacy Policy',
    'save_refund_policy' => 'Save Refund Policy',
    'privacy_policy_updated' => 'Privacy policy has been updated successfully.',
    'refund_policy_updated' => 'Refund policy has been updated successfully.',

    'social_links' => 'Social Links',
    'social_links_admin_description' => 'Manage the social media icons displayed on the site. You can add, edit, show/hide, or delete any platform.',
    'social_links_updated' => 'Social media links have been updated successfully.',
    'add_social_platform' => 'Add Platform',
    'save_social_links' => 'Save Social Links',
    'choose_platform' => 'Choose a Platform',
    'or_custom_platform' => 'Or add a custom platform',
    'platform_name' => 'Platform Name',
    'platform_icon' => 'Font Awesome Icon Class',
    'add_custom' => 'Add Custom',
    'platform_name_required' => 'Please enter a platform name.',
    ...
    // Site Logo
    'site_logo_tab' => 'Site Logo',
    'site_logo_description' => 'Upload a custom logo that appears in the site header, mobile navigation, and footer. Supported formats: PNG, JPG, WebP, SVG. Maximum size: 2 MB. Recommended: transparent background, max 500×200 px.',
    'logo_upload' => 'Upload Logo',
    'logo_change' => 'Change Logo',
    'logo_save' => 'Save Logo',
    'logo_delete' => 'Remove Logo',
    'logo_delete_hint' => 'This will revert to the default site logo.',
    'logo_delete_confirm' => 'Are you sure you want to remove the custom logo? The site will revert to the default logo.',
    'logo_updated' => 'Site logo has been updated successfully.',
    'logo_deleted' => 'Custom logo has been removed. Using default logo.',
    'logo_custom_active' => 'Custom logo is active',
    'logo_using_default' => 'Using default logo',
    'logo_allowed_formats' => 'PNG, JPG, WebP, or SVG (max 2 MB)',

    // Site Icon / Favicon
    'site_icon' => 'Site Icon',
    'site_icon_description' => 'Upload a custom favicon (site icon) that appears in browser tabs, bookmarks, and mobile home screens. Supported formats: PNG, JPG, WebP, ICO. Maximum size: 512 KB.',
    'favicon_upload' => 'Upload Favicon',
    'favicon_change' => 'Change Favicon',
    'favicon_save' => 'Save Favicon',
    'favicon_delete' => 'Remove Favicon',
    'favicon_delete_hint' => 'This will revert to the default site icon.',
    'favicon_delete_confirm' => 'Are you sure you want to remove the custom favicon? The site will revert to the default icon.',
    'favicon_updated' => 'Site icon has been updated successfully.',
    'favicon_deleted' => 'Custom site icon has been removed. Using default favicon.',
    'favicon_custom_active' => 'Custom favicon is active',
    'favicon_using_default' => 'Using default favicon',
    'favicon_allowed_formats' => 'PNG, JPG, WebP, or ICO (max 512 KB)',
    'favicon_required' => 'Please select a favicon file to upload.',
    'favicon_must_be_file' => 'The favicon must be a valid file.',
    'favicon_max_size' => 'The favicon must not be larger than :size KB.',
    'favicon_invalid_type' => 'Invalid file type. Allowed formats: PNG, JPG, WebP, ICO.',
    'favicon_invalid_image' => 'The file does not appear to be a valid image.',
    'favicon_dangerous_content' => 'The file was rejected for security reasons.',
    'favicon_upload_failed' => 'Failed to upload the favicon. Please try again.',
