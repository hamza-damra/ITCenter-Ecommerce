...
<form action="<?php echo e(route('admin.products.store')); ?>" method="POST" enctype="multipart/form-data" class="product-form-grid">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                            rows="5" 
                            placeholder="https://example.com/image1.jpg&#10;https://example.com/image2.jpg"><?php echo e(old('additional_images')); ?></textarea>
                        <p class="form-text">
                    ...
                    <?php if(isset($customSections) && $customSections->count() > 0): ?>
                        ...
                        <label class="checkbox-group">
                            <input 
                                ...
                                <?php echo e(in_array($cs->id, old('home_sections', [])) ? 'checked' : ''); ?>>
                            <span>
