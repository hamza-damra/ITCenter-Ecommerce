...
<div class="admin-hero">
    <div class="admin-hero-content">
        <div class="admin-hero-text">
            ...
            <div>
                <h1><?php echo e(__('messages.edit_section')); ?></h1>
                <p><?php echo e(__('messages.edit_section_subtitle')); ?></p>
            </div>
        </div>
...
<form action="<?php echo e(route('admin.home-sections.update', $section)); ?>" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="display_order" class="form-control <?php echo e($errors->has('display_order') ? 'is-invalid' : ''); ?>"
                            value="<?php echo e(old('display_order', $section->display_order)); ?>" min="1" required>
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="title_en" class="form-control" value="<?php echo e(old('title_en', $section->title_en)); ?>" maxlength="120">
                        </div>
                        <div class="form-group">
                            <label class="form-label"><?php echo e(__('messages.subtitle')); ?> (<?php echo e(__('messages.english')); ?>)</label>
                            <input type="text" name="subtitle_en" class="form-control" value="<?php echo e(old('subtitle_en', $section->subtitle_en)); ?>" maxlength="255">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="title_ar" class="form-control" value="<?php echo e(old('title_ar', $section->title_ar)); ?>" maxlength="120" dir="rtl">
                        </div>
                        <div class="form-group">
                            <label class="form-label"><?php echo e(__('messages.subtitle')); ?> (<?php echo e(__('messages.arabic')); ?>)</label>
                            <input type="text" name="subtitle_ar" class="form-control" value="<?php echo e(old('subtitle_ar', $section->subtitle_ar)); ?>" maxlength="255" dir="rtl">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="title_he" class="form-control" value="<?php echo e(old('title_he', $section->title_he)); ?>" maxlength="120" dir="rtl">
                        </div>
                        <div class="form-group">
                            <label class="form-label"><?php echo e(__('messages.subtitle')); ?> (<?php echo e(__('messages.hebrew')); ?>)</label>
                            <input type="text" name="subtitle_he" class="form-control" value="<?php echo e(old('subtitle_he', $section->subtitle_he)); ?>" maxlength="255" dir="rtl">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="settings[max_products]" class="form-control"
                            value="<?php echo e(old('settings.max_products', $section->getSetting('max_products', 8))); ?>" min="1" max="50">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="settings[cards_to_scroll]" class="form-control"
                            value="<?php echo e(old('settings.cards_to_scroll', $section->getSetting('cards_to_scroll', 1))); ?>" min="1" max="10">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="settings[auto_scroll_interval]" class="form-control"
                            value="<?php echo e(old('settings.auto_scroll_interval', $section->getSetting('auto_scroll_interval', 5000))); ?>" min="1000" max="30000" step="500">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="settings[background_color]" class="form-control"
                            value="<?php echo e(old('settings.background_color', $section->getSetting('background_color'))); ?>" placeholder="#ffffff">
    ...
    <div style="margin-top: 1.5rem; display: flex; gap: 1rem; justify-content: flex-end;">
        ...
        <button type="submit" class="btn btn-primary">
            <i class="fas fa-save"></i> <?php echo e(__('messages.update_section')); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hamza Damra\Documents\ITCenter-Ecommerce\resources\views/admin/home-sections/edit.blade.php ENDPATH**/ ?>