...
<?php $__env->startSection('title', __('messages.edit_promotional_ad')); ?>
...
<div class="page-header">
    <div class="page-header-content">
        <h1><i class="fas fa-edit"></i> <?php echo e(__('messages.edit_promotional_ad')); ?></h1>
        <p><?php echo e(__('messages.update_promotional_ad_description')); ?></p>
    </div>
...
<form action="<?php echo e(route('admin.promotional-ads.update', $promotionalAd)); ?>" method="POST" enctype="multipart/form-data" class="promo-ad-form-grid">
    <?php echo csrf_field(); ?>
    ...
    <div style="display: flex; flex-direction: column; gap: 24px;">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <!-- Current Image -->
                <?php if($promotionalAd->image_path): ?>
                <div class="current-image-container">
                    <span class="current-image-label"><?php echo e(__('messages.current_ad_image')); ?></span>
                    <img src="<?php echo e($promotionalAd->image_url); ?>" alt="<?php echo e(__('messages.promotional_ad')); ?>" class="current-image">
                </div>
                <?php endif; ?>

                <div class="form-group">
                    <label for="image" class="form-label">
                        <?php echo e(__('messages.new_image')); ?>

                        <span style="color: #64748b; font-size: 12px;">(<?php echo e(__('messages.optional_replace')); ?>)</span>
                    </label>
                    <div class="image-upload-box" onclick="document.getElementById('image').click()">
                        <div class="upload-placeholder">
                            <i class="fas fa-cloud-upload-alt"></i>
                            <p><?php echo e(__('messages.click_to_upload_new')); ?></p>
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    <p class="change-image-hint">
                        <i class="fas fa-info-circle"></i> <?php echo e(__('messages.image_replace_hint')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="position-selector">
                        <div class="position-option">
                            <input type="radio" id="position_left" name="position" value="left" <?php echo e(old('position', $promotionalAd->position) == 'left' ? 'checked' : ''); ?> required>
                        ...
                        <div class="position-option">
                            <input type="radio" id="position_right" name="position" value="right" <?php echo e(old('position', $promotionalAd->position) == 'right' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                        value="<?php echo e(old('link', $promotionalAd->link)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group" style="margin-top: 20px;">
                    ...
                    <label class="checkbox-group">
                        <input 
                            ...
                            name="is_active" 
                            value="1" 
                            <?php echo e(old('is_active', $promotionalAd->is_active) ? 'checked' : ''); ?>>
                        <span>
        ...
        <div style="display: flex; gap: 12px; padding-top: 24px;">
            <button type="submit" class="btn btn-success">
                <i class="fas fa-save"></i> <?php echo e(__('messages.update_promotional_ad')); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rashe\Desktop\it-center\laravel-app\resources\views/admin/promotional-ads/edit.blade.php ENDPATH**/ ?>