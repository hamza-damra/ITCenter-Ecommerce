    ...
    <div class="reviews-header">
        <div>
            ...
            <p class="reviews-header-subtitle">
                <?php echo e(__('messages.share_your_experience') ?? 'Have this product? Share your experience with other customers.'); ?>
    ...
    <div class="reviews-controls">
        <div>
            ...
            <div class="reviews-controls-label">
                <?php echo e(__('messages.sort_by')); ?>:
                <span style="font-weight: 500;"><?php echo e(__('messages.most_recent')); ?></span>
            </div>
        </div>
        <div class="sort-dropdown-wrapper">
            <span class="sort-dropdown-label"><?php echo e(__('messages.sort_by')); ?></span>
            ...
            <button type="button" class="custom-dropdown-trigger" id="sort-dropdown-trigger" aria-haspopup="listbox" aria-expanded="false">
                <span class="selected-text"><?php echo e(__('messages.most_recent')); ?></span>
        ...
        <?php if(!$hasReviewed): ?>
            <div class="floating-review-cta" id="floating-review-cta">
                <button type="button" onclick="openReviewFormAndScroll()">
                    ...
                    <?php echo e(__('messages.write_your_review') ?? 'Write your review'); ?>
...
<script>
    ...
    (function() {
        ...
        window.reviewsProductId = <?php echo e($product->id); ?>;
        ...
        window.submitReview = async function(event) {
            ...
            try {
                ...
                if (response.status === 403) {
                    const errorData = await response.json().catch(() => ({}));
                    const errorMessage = errorData.message || '<?php echo e(__("messages.review_requires_purchase_shipped") ?? "You must purchase and receive this product before you can review it"); ?>';
                    showToast(errorMessage, 'error');
                    return;
                }
...
<?php /**PATH C:\Users\Hamza Damra\Documents\ITCenter-Ecommerce\resources\views/partials/reviews-section.blade.php ENDPATH**/ ?>