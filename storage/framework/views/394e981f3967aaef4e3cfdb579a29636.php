<?php $__env->startSection('title', 'Home - IT Center'); ?>

<?php $__env->startSection('content'); ?>
<style>
    /* Hero Section */
    .hero-section {
        background: linear-gradient(to right, rgba(0, 0, 0, 0.2), transparent), radial-gradient(circle, rgba(0, 0, 0, 0.5),transparent), url('<?php echo e(asset('images/assets/wallpaper2.png')); ?>');
...
<div class="hero-section">
    <div class="hero-container">
        <div class="hero-content">
            ...
            <a href="<?php echo e(route('products')); ?>" class="hero-btn">Shop Now</a>
        </div>
    </div>
</div>
...
<div class="categories-section">
    <div class="container">
        <div class="section-header">
            <h2>Categories</h2>
            <a href="<?php echo e(route('categories')); ?>" class="view-more">
                View More <i class="fas fa-arrow-right"></i>
            </a>
        </div>

        <div class="categories-grid">
            <div class="category-item" onclick="window.location.href='<?php echo e(route('categories')); ?>'">
                <div class="category-icon">
                    <img src="<?php echo e(asset('images/products/screen.png')); ?>" alt="Computers">
                </div>
            ...
            <div class="category-item" onclick="window.location.href='<?php echo e(route('categories')); ?>'">
                <div class="category-icon">
                    <img src="<?php echo e(asset('images/products/1024.png')); ?>" alt="Printer">
                </div>
            ...
            <div class="category-item" onclick="window.location.href='<?php echo e(route('categories')); ?>'">
                <div class="category-icon">
                    <img src="<?php echo e(asset('images/products/mouse.png')); ?>" alt="Mobile Accessories">
                </div>
            ...
            <div class="category-item" onclick="window.location.href='<?php echo e(route('categories')); ?>'">
                <div class="category-icon">
                    <img src="<?php echo e(asset('images/products/ssd.png')); ?>" alt="Laptop Bag">
                </div>
            ...
            <div class="category-item" onclick="window.location.href='<?php echo e(route('categories')); ?>'">
                <div class="category-icon">
                    <img src="<?php echo e(asset('images/products/screen.png')); ?>" alt="Laptop">
                </div>
            ...
            <div class="category-item" onclick="window.location.href='<?php echo e(route('categories')); ?>'">
                <div class="category-icon">
                    <img src="<?php echo e(asset('images/products/keyboardrazer.png')); ?>" alt="Laptop Accessories">
                </div>
            ...
            <div class="category-item" onclick="window.location.href='<?php echo e(route('categories')); ?>'">
                <div class="category-icon">
                    <img src="<?php echo e(asset('images/products/screen.png')); ?>" alt="Monitors">
                </div>
            ...
            <div class="category-item" onclick="window.location.href='<?php echo e(route('categories')); ?>'">
                <div class="category-icon">
                    <img src="<?php echo e(asset('images/products/controllerxbox.png')); ?>" alt="Computer Case">
                </div>
            ...
            <div class="category-item" onclick="window.location.href='<?php echo e(route('categories')); ?>'">
                <div class="category-icon">
                    <img src="<?php echo e(asset('images/products/usb.png')); ?>" alt="Motherboard">
                </div>
            ...
            <div class="category-item" onclick="window.location.href='<?php echo e(route('categories')); ?>'">
                <div class="category-icon">
                    <img src="<?php echo e(asset('images/products/1024.png')); ?>" alt="CPU">
                </div>
            ...
            <div class="category-item" onclick="window.location.href='<?php echo e(route('categories')); ?>'">
                <div class="category-icon">
                    <img src="<?php echo e(asset('images/products/mouse.png')); ?>" alt="COOLER">
                </div>
            ...
            <div class="category-item" onclick="window.location.href='<?php echo e(route('categories')); ?>'">
                <div class="category-icon">
                    <img src="<?php echo e(asset('images/products/ssd.png')); ?>" alt="GRAPHIC CARD">
                </div>
...
<div class="brands-section">
    <div class="container">
        <div class="section-header">
            ...
            <a href="<?php echo e(route('brands')); ?>" class="view-more">
...
<div class="banners-section">
    <div class="container">
        <div class="banners-slider">
            <div class="banner-large" onclick="window.location.href='<?php echo e(route('products')); ?>'">
                <img src="https://via.placeholder.com/900x350/667eea/fff?text=Windows+11+Upgrade+Special" alt="Windows 11">
            </div>
            <div class="banner-small" onclick="window.location.href='<?php echo e(route('products')); ?>'">
...
<div class="container">
    <div class="special-cards">
        <div class="special-card" onclick="window.location.href='<?php echo e(route('products')); ?>'">
            ...
            <div class="special-card-content">
                ...
                <a href="<?php echo e(route('products')); ?>" class="special-card-btn">
    ...
    <div class="builder-cards">
        <div class="builder-card" onclick="window.location.href='<?php echo e(route('products')); ?>'">
            <div class="builder-card-title">PC Builder</div>
            <div class="builder-card-link">Check it out ›</div>
            <div class="builder-card-image">
                <img src="<?php echo e(asset('images/products/screen.png')); ?>" alt="PC Builder">
            </div>
        </div>
        ...
        <div class="builder-card" onclick="window.location.href='<?php echo e(route('products')); ?>'">
            ...
            <div class="builder-card-link">Check it out ›</div>
            <div class="builder-card-image">
                <img src="<?php echo e(asset('images/products/controllerxbox.png')); ?>" alt="NAS Builder">
            </div>
        </div>
        ...
        <div class="builder-card" onclick="window.location.href='<?php echo e(route('products')); ?>'">
            ...
            <div class="builder-card-link">Check it out ›</div>
            <div class="builder-card-image">
                <img src="<?php echo e(asset('images/products/ssd.png')); ?>" alt="PC Upgrader">
            </div>
        </div>
        ...
        <div class="builder-card" onclick="window.location.href='<?php echo e(route('products')); ?>'">
            ...
            <div class="builder-card-link">Check it out ›</div>
            <div class="builder-card-image">
                <img src="<?php echo e(asset('images/products/mouse.png')); ?>" alt="Gaming PC">
            </div>
        </div>
        ...
        <div class="builder-card" onclick="window.location.href='<?php echo e(route('products')); ?>'">
            ...
            <div class="builder-card-link">Check it out ›</div>
            <div class="builder-card-image">
                <img src="<?php echo e(asset('images/products/1024.png')); ?>" alt="Server">
            </div>
        </div>
    </div>
    ...
    <div class="product-grid">
        <div class="product-card" onclick="window.location.href='<?php echo e(route('product.detail', 1)); ?>'">
            <div class="product-image">
                <div class="wishlist-btn" onclick="event.stopPropagation();">
                    <i class="far fa-heart"></i>
                </div>
                <img src="<?php echo e(asset('images/products/ssd.png')); ?>" alt="SSD Storage">
            </div>
        ...
        <div class="product-card" onclick="window.location.href='<?php echo e(route('product.detail', 2)); ?>'">
            <div class="product-image">
                <div class="wishlist-btn" onclick="event.stopPropagation();">
                    <i class="far fa-heart"></i>
                </div>
                <img src="<?php echo e(asset('images/products/1024.png')); ?>" alt="Network Adapter">
            </div>
            <div class="product-info">
        ...
        <div class="product-card" onclick="window.location.href='<?php echo e(route('product.detail', 3)); ?>'">
            <div class="product-image">
                <div class="wishlist-btn" onclick="event.stopPropagation();">
                    <i class="far fa-heart"></i>
                </div>
                <div class="product-badge">HOT</div>
                <img src="<?php echo e(asset('images/products/keyboardrazer.png')); ?>" alt="Mechanical Keyboard RGB">
            </div>
            <div class="product-info">
        ...
        <div class="product-card" onclick="window.location.href='<?php echo e(route('product.detail', 4)); ?>'">
            <div class="product-image">
                <div class="wishlist-btn" onclick="event.stopPropagation();">
                    <i class="far fa-heart"></i>
                </div>
                <img src="<?php echo e(asset('images/products/usb.png')); ?>" alt="USB-C to Lightning">
            </div>
            <div class="product-info">
        ...
        <div class="product-card" onclick="window.location.href='<?php echo e(route('product.detail', 5)); ?>'">
            <div class="product-image">
                <div class="wishlist-btn" onclick="event.stopPropagation();">
                    <i class="far fa-heart"></i>
                </div>
                <div class="product-badge">NEW</div>
                <img src="<?php echo e(asset('images/products/screen.png')); ?>" alt="Monitor">
            </div>
            <div class="product-info">
        ...
        <div class="product-card" onclick="window.location.href='<?php echo e(route('product.detail', 6)); ?>'">
            <div class="product-image">
                <div class="wishlist-btn" onclick="event.stopPropagation();">
                    <i class="far fa-heart"></i>
                </div>
                <img src="<?php echo e(asset('images/products/mouse.png')); ?>" alt="Gaming Mouse">
            </div>
            <div class="product-info">
        ...
        <div class="product-card" onclick="window.location.href='<?php echo e(route('product.detail', 7)); ?>'">
            <div class="product-image">
                <div class="wishlist-btn" onclick="event.stopPropagation();">
                    <i class="far fa-heart"></i>
                </div>
                <div class="product-badge">SALE</div>
                <img src="<?php echo e(asset('images/products/controllerxbox.png')); ?>" alt="Controller">
            </div>
            <div class="product-info">
        ...
        <div class="product-card" onclick="window.location.href='<?php echo e(route('product.detail', 8)); ?>'">
            <div class="product-image">
                <div class="wishlist-btn" onclick="event.stopPropagation();">
                    <i class="far fa-heart"></i>
                </div>
                <img src="<?php echo e(asset('images/products/1024.png')); ?>" alt="Webcam">
            </div>
            <div class="product-info">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rashe\Desktop\it-center\laravel-app\resources\views\home-new.blade.php ENDPATH**/ ?>