<?php $__env->startSection('title', __('messages.edit_tag')); ?>

<?php $__env->startSection('content'); ?>
<div class="page-header">
    <div class="page-header-content">
        <h1><i class="fas fa-edit"></i> <?php echo e(__('messages.edit_tag')); ?></h1>
        <p><?php echo e(__('messages.update_tag_information')); ?>: <strong><?php echo e($tag->name_en); ?></strong></p>
    </div>
...
<form action="<?php echo e(route('admin.tags.update', $tag)); ?>" method="POST" style="max-width: 800px;">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                           value="<?php echo e(old('name_en', $tag->name_en)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                           value="<?php echo e(old('name_ar', $tag->name_ar)); ?>" required dir="rtl">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="color" id="color" name="color" class="form-control" 
                           value="<?php echo e(old('color', $tag->color)); ?>" style="height: 42px; padding: 4px;">
...
unset($__errorArgs, $__bag); ?>" 
                           value="<?php echo e(old('icon', $tag->icon)); ?>" placeholder="e.g., fas fa-gamepad">
...
unset($__errorArgs, $__bag); ?>" 
                       value="<?php echo e(old('position', $tag->position)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <label class="checkbox-group">
                    <input type="checkbox" id="is_active" name="is_active" value="1" <?php echo e(old('is_active', $tag->is_active) ? 'checked' : ''); ?>>
                    <span>
    ...
    <div style="display: flex; gap: 12px; padding-top: 24px;">
        <button type="submit" class="btn btn-success">
            <i class="fas fa-save"></i> <?php echo e(__('messages.update_tag')); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hamza Damra\Documents\ITCenter-Ecommerce\resources\views/admin/tags/edit.blade.php ENDPATH**/ ?>