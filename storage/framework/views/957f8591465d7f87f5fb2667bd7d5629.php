...
<div class="admin-content">
    <div class="content-header" style="margin-bottom: 2rem;">
        <div>
            <h1 style="display: flex; align-items: center; gap: 1rem; margin-bottom: 0.5rem;">
                <i class="fas fa-bullhorn" style="color: #667eea;"></i> <?php echo e(__('messages.create_new_promotional_offer')); ?>

            </h1>
            <p style="color: #666; margin: 0;"><?php echo e(__('messages.create_promotional_subtitle')); ?></p>
        </div>
    ...
    <form action="<?php echo e(route('admin.promotional-offers.store')); ?>" method="POST" id="promoForm">
        <?php echo csrf_field(); ?>
        ...
        <div class="promo-card">
            <div class="card-header-custom">
                ...
                <div>
                    <h3><?php echo e(__('messages.product_selection')); ?></h3>
            ...
            <div class="card-body-custom">
                <div class="form-group-enhanced">
                    <label for="product_id"><?php echo e(__('messages.product')); ?> <span class="required">*</span></label>
        ...
        <div class="promo-card">
            <div class="card-header-custom">
                ...
                <div>
                    <h3><?php echo e(__('messages.offer_title_section')); ?></h3>
            ...
            <div class="card-body-custom">
                <div class="form-row">
                    <div class="form-group-enhanced">
                        <label for="title_ar">
                            <span class="flag-icon">🇸🇦</span> <?php echo e(__('messages.title_arabic')); ?> <span class="required">*</span>
                        </label>
                    ...
                    <div class="form-group-enhanced">
                        <label for="title_en">
                            <span class="flag-icon">🇬🇧</span> <?php echo e(__('messages.title_english')); ?> <span class="required">*</span>
                        </label>
                    ...
                    <div class="form-group-enhanced">
                        <label for="title_he">
                            <span class="flag-icon">🇮🇱</span> <?php echo e(__('messages.title_hebrew')); ?>
        ...
        <div class="promo-card">
            <div class="card-header-custom">
                ...
                <div>
                    <h3><?php echo e(__('messages.pricing')); ?></h3>
                ...
                <div class="pricing-grid">
                    <div class="form-group-enhanced">
                        <label for="original_price">
                            <i class="fas fa-dollar-sign"></i> <?php echo e(__('messages.original_price')); ?> <span class="required">*</span>
                        </label>
                    ...
                    <div class="form-group-enhanced">
                        <label for="sale_price">
                            <i class="fas fa-percent"></i> <?php echo e(__('messages.sale_price')); ?> <span class="required">*</span>
                        </label>
                        <div class="input-with-icon">
                    ...
                    <div class="discount-display">
                        <div class="discount-label"><?php echo e(__('messages.calculated_discount')); ?></div>
                        <div id="discount_preview" class="discount-value">
                            <span class="no-discount"><?php echo e(__('messages.enter_prices_to_calculate')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="promo-card">
            <div class="card-header-custom">
                ...
                <div>
                    <h3><?php echo e(__('messages.offer_features')); ?></h3>
                ...
                <div class="form-row">
                    <div class="form-group-enhanced">
                        <label for="features_ar">
                            <span class="flag-icon">🇸🇦</span> <?php echo e(__('messages.features_arabic')); ?>
                    ...
                    <div class="form-group-enhanced">
                        <label for="features_en">
                            <span class="flag-icon">🇬🇧</span> <?php echo e(__('messages.features_english')); ?>
                    ...
                    <div class="form-group-enhanced">
                        <label for="features_he">
                            <span class="flag-icon">🇮🇱</span> <?php echo e(__('messages.features_hebrew')); ?>

                        </label>
                        <textarea name="features_he" id="features_he" class="form-control-enhanced textarea-enhanced" 
                                  rows="4"><?php echo e(old('features_he')); ?></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="promo-card">
            <div class="card-header-custom">
                ...
                <div>
                    <h3><?php echo e(__('messages.offer_duration')); ?></h3>
                ...
                <div class="date-grid">
                    <div class="form-group-enhanced">
                        <label for="start_date">
                            <i class="fas fa-calendar-check"></i> <?php echo e(__('messages.start_date_label')); ?> <span class="required">*</span>
                        </label>
                    ...
                    <div class="form-group-enhanced">
                        <label for="end_date">
                            <i class="fas fa-calendar-times"></i> <?php echo e(__('messages.end_date_label')); ?> <span class="required">*</span>
                        </label>
        ...
        <div class="promo-card">
            <div class="card-header-custom">
                ...
                <div>
                    <h3><?php echo e(__('messages.settings')); ?></h3>
                    <p><?php echo e(__('messages.additional_settings')); ?></p>
                </div>
            </div>
                ...
                <div class="settings-grid">
                    <div class="form-group-enhanced">
                        <label for="display_order">
                            <i class="fas fa-sort-numeric-down"></i> <?php echo e(__('messages.display_order')); ?>
                        ...
                        <small class="form-hint">
                            <i class="fas fa-info-circle"></i> <?php echo e(__('messages.display_order_hint')); ?>
                        ...
                        <div class="toggle-wrapper">
                            <label class="toggle-label">
                                ...
                                <span class="toggle-text">
                                    <i class="fas fa-power-off"></i> <?php echo e(__('messages.activate_offer_immediately')); ?>

                                </span>
                            </label>
                            <small class="form-hint"><?php echo e(__('messages.will_appear_on_homepage')); ?></small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="form-actions-enhanced">
            <button type="submit" class="btn-enhanced btn-primary-enhanced">
                ...
                <span><?php echo e(__('messages.save_promotional_offer')); ?></span>
            </button>
            <a href="<?php echo e(route('admin.promotional-offers.index')); ?>" class="btn-enhanced btn-secondary-enhanced">
                <i class="fas fa-times"></i>
                <span><?php echo e(__('messages.cancel')); ?></span>
            </a>
        </div>
    </form>
</div>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rashe\Desktop\it-center\laravel-app\resources\views\admin\promotional-offers\create.blade.php ENDPATH**/ ?>