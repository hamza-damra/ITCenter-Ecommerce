...
@media (max-width: 768px) {
    ...
    .btn-wishlist::after {
        content: '<?php echo e(__("messages.add_to_wishlist")); ?>';
        font-size: 1rem;
        font-weight: 500;
    }
    ...
    <div class="container">
        ...
        <div class="specifications-section">
            <h2 class="section-title">
                ...
                <?php echo e(__('messages.technical_specifications')); ?>

            </h2>
            <div class="specs-grid">
                
                <?php if($hasNewSpecs): ?>
                    <?php $__currentLoopData = $formattedSpecs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!empty($spec['value'])): ?>
                            <div class="spec-item">
                                <span class="spec-label">
                                    <i class="fas fa-check-circle"></i>
                                    <?php echo e($spec['label']); ?>:
                                </span>
                                <span class="spec-value"><?php echo e($spec['value']); ?></span>
                            </div>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                
                <?php elseif($hasLegacySpecs): ?>
                ...
                <div class="spec-item">
                    <span class="spec-label">
                        ...
                        <?php echo e(__('messages.sku') ?? 'SKU'); ?>:
                    </span>
                ...
                <?php if($product->weight): ?>
                    <div class="spec-item">
                        <span class="spec-label">
                            ...
                            <?php echo e(__('messages.weight') ?? 'Weight'); ?>:
                        </span>
                        <span class="spec-value"><?php echo e($product->weight); ?> <span class="spec-unit">kg</span></span>
                    </div>
                <?php endif; ?>
                ...
                <?php if($product->warranty): ?>
                    <div class="spec-item">
                        <span class="spec-label">
                            ...
                            <?php echo e(__('messages.warranty')); ?>:
                        </span>
                ...
                <?php if($product->length && $product->width && $product->height): ?>
                    <div class="spec-item">
                        <span class="spec-label">
                            ...
                            <?php echo e(__('messages.dimensions') ?? 'Dimensions'); ?>:
                        </span>
                        <span class="spec-value"><?php echo e($product->length); ?> × <?php echo e($product->width); ?> × <?php echo e($product->height); ?> <span class="spec-unit">cm</span></span>
                    </div>
                <?php endif; ?>
                
                
                <?php if(!$hasNewSpecs && !$hasLegacySpecs && !$product->weight && !$product->warranty): ?>
                    <div class="specs-empty" style="grid-column: 1 / -1;">
                        <i class="fas fa-info-circle"></i>
                        <p><?php echo e(__('messages.no_specifications_available') ?? 'No specifications available for this product.'); ?></p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        ?>
        <?php if($description && $description !== $shortDesc): ?>
    ...
    <div class="container">
        ...
        <div class="products-grid">
            <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('product.detail', $relatedProduct)); ?>" style="text-decoration: none; color: inherit;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hamza Damra\Documents\ITCenter-Ecommerce\resources\views/product-detail.blade.php ENDPATH**/ ?>