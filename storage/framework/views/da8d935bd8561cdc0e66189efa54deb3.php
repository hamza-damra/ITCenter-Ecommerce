<?php $__env->startSection('title', $offer->name . ' - Special Offer - IT Center'); ?>
    ...
    <div class="container">
        ...
        <div class="offer-hero">
            <div class="offer-hero-content">
                ...
                <h1 class="offer-title"><?php echo e($offer->name); ?></h1>
                <p class="offer-description"><?php echo e($offer->description); ?></p>
                
                <div class="offer-meta">
                    <div class="offer-meta-item">
                        <i class="fas fa-calendar-alt"></i>
                        <span>Valid from <?php echo e($offer->start_date->format('M d, Y')); ?></span>
                    </div>
                    <div class="offer-meta-item">
                        <i class="fas fa-calendar-check"></i>
                        <span>Until <?php echo e($offer->end_date->format('M d, Y')); ?></span>
                    </div>
                    <?php if($offer->discount_type && $offer->discount_value): ?>
                    <div class="offer-meta-item">
                        ...
                        <span>
                            ...
                            <?php else: ?>
                                ₪<?php echo e(number_format($offer->discount_value, 0)); ?> OFF
                            <?php endif; ?>
                        </span>
                    </div>
                    <?php endif; ?>
                ...
                <!-- Countdown Timer -->
                <?php if($offer->end_date->isFuture()): ?>
        ...
        <div class="offer-stats">
            <div class="stat-card">
                <div class="stat-value"><?php echo e($offer->products->count()); ?></div>
            ...
            <?php endif; ?>
            <?php if($offer->min_purchase_amount): ?>
            <div class="stat-card">
                <div class="stat-value">₪<?php echo e(number_format($offer->min_purchase_amount, 0)); ?></div>
                <div class="stat-label">Minimum Purchase</div>
            </div>
            <?php endif; ?>
            <div class="stat-card">
                <div class="stat-value"><?php echo e($offer->end_date->diffInDays(now())); ?></div>
            ...
            <div class="product-grid">
                ...
                <div class="product-card" onclick="window.location.href='<?php echo e(route('product.detail', $product->slug)); ?>'">
                    <div class="product-image">
                        <?php if($offer->discount_type === 'percentage'): ?>
                        <div class="discount-badge">-<?php echo e($offer->discount_value); ?>%</div>
                        <?php elseif($offer->discount_type === 'fixed'): ?>
                        <div class="discount-badge">-₪<?php echo e(number_format($offer->discount_value, 0)); ?></div>
                        <?php endif; ?>
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-brand">
                            <i class="fas fa-building"></i> <?php echo e($product->brand->name); ?>
                        ...
                        <div class="product-pricing">
                            <?php if($product->sale_price && $product->sale_price < $product->price): ?>
                                ...
                                <span class="sale-price">₪<?php echo e(number_format($product->sale_price, 0)); ?></span>
                                <?php
                                    $savings = (($product->price - $product->sale_price) / $product->price) * 100;
                                ?>
                                <span class="savings">Save <?php echo e(number_format($savings, 0)); ?>%</span>
                            <?php else: ?>
                                <span class="sale-price">₪<?php echo e(number_format($product->price, 0)); ?></span>
                            <?php endif; ?>
                        </div>

                        <div class="product-actions">
                            <button class="btn-view" onclick="event.stopPropagation(); window.location.href='<?php echo e(route('product.detail', $product->slug)); ?>'">
...
<script>
    // Countdown Timer
    const endDate = new Date("<?php echo e($offer->end_date->toIso8601String()); ?>").getTime();
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rashe\Desktop\it-center\laravel-app\resources\views\offer-detail.blade.php ENDPATH**/ ?>