    ...
    <div class="auth-card">
        <div class="auth-right">
            <div class="auth-header">
                ...
                <p><?php echo e(__('messages.sign_in_to_continue')); ?></p>
            </div>
            ...
            <form action="<?php echo e(route('login.post')); ?>" method="POST" id="loginForm">
                ...
                <div class="form-group">
                    <label for="email"><?php echo e(__('messages.email_address')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <button type="submit" class="btn-submit" id="submitBtn">
                    ...
                    <span><?php echo e(__('messages.sign_in')); ?></span>
                </button>
            </form>

            
            <?php if(config('services.google.client_id') || config('services.facebook.client_id')): ?>
                <div class="social-login">
                    <div class="social-divider"><?php echo e(__('messages.or_continue_with')); ?></div>
                    
                    <?php if(config('services.google.client_id')): ?>
                        <a href="<?php echo e(route('auth.google')); ?>" class="social-btn google">
                    ...
                    <?php if(config('services.facebook.client_id')): ?>
                        <a href="<?php echo e(route('auth.facebook')); ?>" class="social-btn facebook">
                            <i class="fab fa-facebook-f"></i>
                            <?php echo e(__('messages.continue_with_facebook')); ?>
            ...
            <div class="auth-footer">
                ...
                <a href="<?php echo e(route('register')); ?>"><?php echo e(__('messages.create_account')); ?></a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rashe\Desktop\it-center\laravel-app\resources\views\auth\login-enhanced.blade.php ENDPATH**/ ?>