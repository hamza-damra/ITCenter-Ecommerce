    ...
    <style>
        ...
        *:not(html):not(body) {
        ...
        .search-bar::before {
            ...
            font-weight: 900;
            position: absolute;
            <?php echo e(is_rtl() ? 'right' : 'left'); ?>: 24px;
            color: #9ca3af;
            font-size: 1rem;
            pointer-events: none;
            transition: color 0.3s ease;
        ...
        .search-bar input {
            padding-<?php echo e(is_rtl() ? 'right' : 'left'); ?>: 52px !important;
        }
        ...
        @media (max-width: 768px) {
            ...
            .mobile-menu-toggle {
                ...
                top: 16px !important;
                <?php echo e(is_rtl() ? 'right' : 'left'); ?>: 16px !important;
            ...
            .nav-menu.active {
                transform: <?php echo e(is_rtl() ? 'translateX(-100%)' : 'translateX(100%)'); ?>;
            }
            ...
            .nav-menu a:hover {
                ...
                color: #fff;
                padding-<?php echo e(is_rtl() ? 'right' : 'left'); ?>: 28px;
            }
            ...
            .nav-menu a.active {
                ...
                padding-<?php echo e(is_rtl() ? 'right' : 'left'); ?>: 24px;
                font-weight: 700;
            }
