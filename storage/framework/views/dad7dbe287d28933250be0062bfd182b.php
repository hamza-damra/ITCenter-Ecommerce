...
<div class="admin-hero">
    <div class="admin-hero-content">
        <div class="admin-hero-text">
            ...
            <div>
                <h1><?php echo e(__('messages.create_role')); ?></h1>
                <p><?php echo e(__('messages.create_role_subtitle')); ?></p>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>" placeholder="<?php echo e(__('messages.role_name_placeholder')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox-group">
                        <input type="checkbox" name="is_active" value="1" id="is_active" <?php echo e(old('is_active', true) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="<?php echo e(__('messages.role_description_placeholder')); ?>"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="permission-group-card <?php echo e($groupHasChecked ? '' : 'collapsed'); ?>" data-group-card="<?php echo e($groupKey); ?>">
                        ...
                        <div class="permission-group-body">
                            <?php $__currentLoopData = $group['permissions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permKey => $permLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <div class="permission-checkbox <?php echo e(in_array($permKey, old('permissions', [])) ? 'checked' : ''); ?>">
                                    <input type="checkbox" name="permissions[]" value="<?php echo e($permKey); ?>" id="perm_<?php echo e($permKey); ?>"
                                        ...
                                        <?php echo e(in_array($permKey, old('permissions', [])) ? 'checked' : ''); ?>
    ...
    <div class="form-actions">
        <button type="submit" class="btn btn-primary">
            <i class="fas fa-save"></i> <?php echo e(__('messages.create_role')); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hamza Damra\Documents\ITCenter-Ecommerce\resources\views/admin/roles/create.blade.php ENDPATH**/ ?>