...
<div class="promo-create-page">
    ...
    <div class="page-hero">
        <div class="hero-content">
            <div class="hero-badge">
                ...
                <span><?php echo e(__('messages.new_offer')); ?></span>
            </div>
            <h1><?php echo e(__('messages.create_new_promotional_offer')); ?></h1>
            <p><?php echo e(__('messages.create_promotional_subtitle')); ?></p>
        </div>
        <a href="<?php echo e(route('admin.promotional-offers.index')); ?>" class="back-btn">
            <i class="fas fa-arrow-left"></i>
            <span><?php echo e(__('messages.back_to_list')); ?></span>
        </a>
    </div>
    ...
    <form action="<?php echo e(route('admin.promotional-offers.store')); ?>" method="POST" id="promoForm" class="promo-form">
        <?php echo csrf_field(); ?>
            ...
            <div class="form-column">
                ...
                <section class="form-section product-section">
                    <div class="section-header">
                        ...
                        <div class="section-title">
                            <h2><?php echo e(__('messages.product_selection')); ?></h2>
                            <p><?php echo e(__('messages.select_product_desc')); ?></p>
                        </div>
                    ...
                    <div class="section-body">
                        ...
                        <div id="product_preview" class="product-preview-card" style="display: none;">
                            ...
                            <div class="preview-details">
                                <span class="preview-label"><?php echo e(__('messages.selected_product')); ?></span>
                                <h4 id="preview_name"></h4>
                                <div class="preview-price">
                                    <span class="price-label"><?php echo e(__('messages.current_price')); ?></span>
                ...
                <section class="form-section titles-section">
                    <div class="section-header">
                        ...
                        <div class="section-title">
                            <h2><?php echo e(__('messages.offer_title_section')); ?></h2>
                            <p><?php echo e(__('messages.offer_title_desc')); ?></p>
                        </div>
                    ...
                    <div class="section-body">
                        <div class="language-tabs">
                            <button type="button" class="lang-tab active" data-lang="ar">
                                ...
                                <span><?php echo e(__('messages.arabic')); ?></span>
                            </button>
                            <button type="button" class="lang-tab" data-lang="en">
                                <span class="flag">🇬🇧</span>
                                <span><?php echo e(__('messages.english')); ?></span>
                            </button>
                            <button type="button" class="lang-tab" data-lang="he">
                                <span class="flag">🇮🇱</span>
                                <span><?php echo e(__('messages.hebrew')); ?></span>
                            </button>
                        </div>
                            ...
                            <div class="tab-pane active" data-lang="ar">
                                <div class="field-group">
                                    ...
                                    <input type="text" name="title_ar" id="title_ar" 
                                           ...
                                           dir="rtl"
                                           required>
                                    <span class="field-hint"><?php echo e(__('messages.title_hint_ar')); ?></span>
                                </div>
                            </div>
                            <div class="tab-pane" data-lang="en">
                                <div class="field-group">
                                    ...
                                    <input type="text" name="title_en" id="title_en" 
                                           ...
                                           required>
                                    <span class="field-hint"><?php echo e(__('messages.title_hint_en')); ?></span>
                                </div>
                            </div>
                            <div class="tab-pane" data-lang="he">
                                <div class="field-group">
                                    ...
                                    <input type="text" name="title_he" id="title_he" 
                                           ...
                                           dir="rtl">
                                    <span class="field-hint optional"><?php echo e(__('messages.optional')); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="form-section features-section">
                    <div class="section-header">
                        ...
                        <div class="section-title">
                            <h2><?php echo e(__('messages.offer_features')); ?></h2>
                            <p><?php echo e(__('messages.offer_features_desc')); ?></p>
                        </div>
                        ...
                        <div class="features-grid">
                            <div class="field-group">
                                <label class="field-label with-flag">
                                    <span class="flag">🇸🇦</span>
                                    <?php echo e(__('messages.features_arabic')); ?>
                                ...
                                <span class="field-hint"><?php echo e(__('messages.features_hint')); ?></span>
                            </div>

                            <div class="field-group">
                                <label class="field-label with-flag">
                                    <span class="flag">🇬🇧</span>
                                    <?php echo e(__('messages.features_english')); ?>
                            ...
                            <div class="field-group">
                                <label class="field-label with-flag">
                                    <span class="flag">🇮🇱</span>
                                    <?php echo e(__('messages.features_hebrew')); ?>

                                </label>
                                <textarea name="features_he" id="features_he" 
                                          class="textarea-input rtl-input" 
                                          rows="4"
                                          dir="rtl"><?php echo e(old('features_he')); ?></textarea>
                                <span class="field-hint optional"><?php echo e(__('messages.optional')); ?></span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-column sidebar-column">
                ...
                <section class="form-section pricing-section sticky-section">
                    <div class="section-header compact">
                        ...
                        <div class="section-title">
                            <h2><?php echo e(__('messages.pricing')); ?></h2>
                            <p><?php echo e(__('messages.pricing_desc')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="section-body">
                        <div class="price-inputs">
                            <div class="field-group">
                                <label class="field-label">
                                    <?php echo e(__('messages.original_price')); ?>
                        ...
                        <div id="discount_calculator" class="discount-calculator">
                            <div class="calculator-header">
                                ...
                                <span><?php echo e(__('messages.calculated_discount')); ?></span>
                            </div>
                            <div class="calculator-body" id="discount_display">
                                <div class="no-calculation">
                                    <i class="fas fa-coins"></i>
                                    <span><?php echo e(__('messages.enter_prices_to_calculate')); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="form-section duration-section">
                    <div class="section-header compact">
                        ...
                        <div class="section-title">
                            <h2><?php echo e(__('messages.offer_duration')); ?></h2>
                            <p><?php echo e(__('messages.offer_duration_desc')); ?></p>
                        </div>
                    </div>
                        ...
                        <div class="date-fields">
                            <div class="field-group">
                                <label class="field-label">
                                    ...
                                    <?php echo e(__('messages.start_date_label')); ?>
                            ...
                            <div class="field-group">
                                <label class="field-label">
                                    ...
                                    <?php echo e(__('messages.end_date_label')); ?>
                ...
                <section class="form-section settings-section">
                    <div class="section-header compact">
                        ...
                        <div class="section-title">
                            <h2><?php echo e(__('messages.settings')); ?></h2>
                        </div>
                    </div>
                    ...
                    <div class="section-body">
                        <div class="field-group">
                            ...
                            <input type="number" name="display_order" id="display_order" 
                                   ...
                                   placeholder="0">
                            <span class="field-hint"><?php echo e(__('messages.display_order_hint')); ?></span>
                        </div>
                        ...
                        <div class="toggle-field">
                            <label class="modern-toggle">
                                ...
                                <span class="toggle-label">
                                    ...
                                    <?php echo e(__('messages.activate_offer_immediately')); ?>

                                </span>
                            </label>
                            <span class="field-hint"><?php echo e(__('messages.will_appear_on_homepage')); ?></span>
                        </div>
                    </div>
                </section>
                ...
                <div class="form-actions">
                    <button type="submit" class="submit-btn">
                        ...
                        <span class="btn-text"><?php echo e(__('messages.save_promotional_offer')); ?></span>
                        <span class="btn-shine"></span>
                    </button>
                    <a href="<?php echo e(route('admin.promotional-offers.index')); ?>" class="cancel-btn">
                        <i class="fas fa-times"></i>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateDuration() {
        ...
        if (start && end && end > start) {
            ...
            let durationStr = '';
            if (days > 0) {
                durationStr += days + ' <?php echo e(__("messages.days")); ?>';
            }
            if (hours > 0) {
                durationStr += (durationStr ? ' <?php echo e(__("messages.and")); ?> ' : '') + hours + ' <?php echo e(__("messages.hours")); ?>';
            }

            durationPreview.style.display = 'flex';
            durationText.textContent = '<?php echo e(__("messages.offer_lasts")); ?>: ' + durationStr;
        } else {
    ...
    promoForm.addEventListener('submit', function(e) {
        ...
        if (sale >= original) {
            e.preventDefault();
            alert('<?php echo e(__("messages.sale_price_must_be_less")); ?>');
        ...
        if (end <= start) {
            e.preventDefault();
            alert('<?php echo e(__("messages.end_date_must_be_after_start")); ?>');
            endDateInput.focus();
            return false;
        }
    });
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hamza Damra\Documents\ITCenter-Ecommerce\resources\views/admin/promotional-offers/create.blade.php ENDPATH**/ ?>