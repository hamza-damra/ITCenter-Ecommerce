    ...
    <style>
        ...
        *:not(html):not(body) {
        ...
        .user-dropdown-menu .user-menu-item:hover {
            ...
            padding-<?php echo e(is_rtl() ? 'right' : 'left'); ?>: 1.2rem !important;
        }
            ...
            <div class="header-icons">
                ...
                <div class="header-icon user-dropdown" style="position: relative;">
                    ...
                    <div class="user-dropdown-menu">
                        <a href="<?php echo e(route('profile.index')); ?>" class="user-menu-item">
                            <i class="fas fa-user"></i>
                            <span><?php echo e(__t('messages.my_profile')); ?></span>
                        </a>
                        <a href="<?php echo e(route('orders.index')); ?>" class="user-menu-item">
