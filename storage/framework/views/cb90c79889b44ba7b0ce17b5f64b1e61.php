...
<form action="<?php echo e(route('admin.products.update', $product)); ?>" method="POST" enctype="multipart/form-data" class="product-form-grid">
    <?php echo csrf_field(); ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                    <label class="form-label"><?php echo e(__('messages.image_source') ?? 'Image Source'); ?></label>
                    <div style="display: flex; gap: 12px;">
                        <label class="checkbox-group" style="margin: 0; flex: 1; padding: 12px; border: 2px solid var(--primary); border-radius: 8px; background: #eff6ff; cursor: pointer;" id="source-file-label">
                            <input type="radio" name="image_source_type" value="file" <?php echo e(old('image_source_type', 'file') === 'file' ? 'checked' : ''); ?> onchange="toggleImageSource('file')">
                            <span>
                                <strong><i class="fas fa-upload"></i> <?php echo e(__('messages.upload_files') ?? 'Upload Files'); ?></strong>
                                <p style="color: #64748b; font-size: 12px; margin-top: 2px;"><?php echo e(__('messages.upload_from_device') ?? 'Upload images from your device (stored on server)'); ?></p>
                            </span>
                        </label>
                        <label class="checkbox-group" style="margin: 0; flex: 1; padding: 12px; border: 2px solid var(--border); border-radius: 8px; cursor: pointer;" id="source-url-label">
                            <input type="radio" name="image_source_type" value="url" <?php echo e(old('image_source_type', 'file') === 'url' ? 'checked' : ''); ?> onchange="toggleImageSource('url')">
                            <span>
                                <strong><i class="fas fa-link"></i> <?php echo e(__('messages.image_url') ?? 'Image URL'); ?></strong>
                                <p style="color: #64748b; font-size: 12px; margin-top: 2px;"><?php echo e(__('messages.paste_external_url') ?? 'Paste external image URLs'); ?></p>
                            </span>
                        </label>
                    </div>
                </div>
                ...
                <?php if($product->main_image): ?>
                    <div class="current-image-container" style="margin-bottom: 16px;">
                        ...
                        <p class="form-text" style="margin-top: 8px;">
                            <i class="fas fa-info-circle"></i> <?php echo e(__('messages.leave_empty_to_keep') ?? 'Leave empty to keep the current image'); ?>
                ...
                <!-- FILE UPLOAD MODE -->
                <div id="image-source-file" style="<?php echo e(old('image_source_type', 'file') === 'file' ? '' : 'display:none;'); ?>">
                    <div class="form-group">
                        <label class="form-label">
                            <?php echo e(__('messages.main_product_image')); ?>

                            <span style="color: #64748b; font-size: 12px;">(<?php echo e(__('messages.optional_on_edit')); ?>)</span>
                        </label>
                        <div class="dropzone-area <?php $__errorArgs = ['main_image_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> dropzone-error <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>" id="main-dropzone" onclick="document.getElementById('main_image_file').click()">
                            ...
                            <div class="dropzone-content" id="main-dropzone-content">
                                ...
                                <p class="dropzone-title"><?php echo e(__('messages.drag_drop_image')); ?></p>
                                <p class="dropzone-subtitle"><?php echo e(__('messages.or_click_to_browse')); ?></p>
                                <span class="dropzone-formats"><?php echo e(__('messages.accepted_formats')); ?></span>
                            </div>
                            <div class="dropzone-preview" id="main-dropzone-preview" style="display:none;">
                                <img id="main-image-preview-img" src="" alt="Preview">
                                <button type="button" class="dropzone-remove" onclick="event.stopPropagation(); removeMainImage();" title="<?php echo e(__('messages.remove')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group" style="margin-top: 20px;">
                        <label class="form-label">
                            ...
                            <span style="color: #64748b; font-size: 12px;">(<?php echo e(__('messages.optional')); ?> - <?php echo e(__('messages.max_10_files')); ?>)</span>
                        </label>
                        <div class="dropzone-area dropzone-multi <?php $__errorArgs = ['additional_images_files'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> dropzone-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?> <?php $__errorArgs = ['additional_images_files.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> dropzone-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="additional-dropzone" onclick="document.getElementById('additional_images_files').click()">
                            ...
                            <div class="dropzone-content" id="additional-dropzone-content">
                                ...
                                <p class="dropzone-title"><?php echo e(__('messages.drag_drop_images')); ?></p>
                                <p class="dropzone-subtitle"><?php echo e(__('messages.or_click_to_browse')); ?></p>
                                <span class="dropzone-formats"><?php echo e(__('messages.select_multiple_images')); ?></span>
                            </div>
                        </div>
                        <div class="dropzone-grid" id="additional-images-preview"></div>
                        <?php $__errorArgs = ['additional_images_files'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- URL MODE (legacy) -->
                <div id="image-source-url" style="<?php echo e(old('image_source_type', 'file') === 'url' ? '' : 'display:none;'); ?>">
                    <div class="form-group">
                        <label for="main_image" class="form-label">
                            <?php echo e(__('messages.main_product_image')); ?>

                            <span style="color: #64748b; font-size: 12px;">(<?php echo e(__('messages.optional_on_edit') ?? 'Optional - leave empty to keep current'); ?>)</span>
                        </label>
                        <input 
                            type="url" 
                            id="main_image" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        <label for="additional_images" class="form-label">
                            ...
                            <span style="color: #64748b; font-size: 12px;">(<?php echo e(__('messages.optional_one_url_per_line') ?? 'Optional - one URL per line'); ?>)</span>
                        </label>
                        <textarea 
...
unset($__errorArgs, $__bag); ?>" 
                            rows="5" 
                            placeholder="https://example.com/image1.jpg&#10;https://example.com/image2.jpg"><?php echo e(old('additional_images', $product->images->where('is_primary', false)->pluck('image_path')->implode("\n"))); ?></textarea>
                        <p class="form-text">
                            <i class="fas fa-info-circle"></i> <?php echo e(__('messages.enter_image_url_per_line') ?? 'Enter each image URL on a separate line'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php if($product->images->where('is_primary', false)->count() > 0): ?>
                    <div class="additional-images-preview" style="margin-top: 16px;">
                        <strong>
                        ...
                        <div class="images-grid" style="margin-top: 10px;">
                            <?php $__currentLoopData = $product->images->where('is_primary', false); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <img src="<?php echo e($image->image_url); ?>" alt="Product Image">
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                additionalInput.addEventListener('change', function() {
                    ...
                    if (this.files && this.files.length) {
                        document.getElementById('additional-dropzone-content').innerHTML =
                            ...
                            '<p class="dropzone-title">' + this.files.length + ' <?php echo e(__("messages.files_selected")); ?></p>' +
                            '<p class="dropzone-subtitle"><?php echo e(__("messages.click_to_change")); ?></p>';
