        ...
        <div class="products-container">
            ...
            <aside class="filter-sidebar" id="filterSidebar">
                <div class="filter-header">
                    <h3><?php echo e(is_rtl() ? 'تصفية' : 'Filters'); ?></h3>
                    <button class="clear-filters-btn" id="clearFiltersBtn" type="button">
                        <?php echo e(is_rtl() ? 'مسح الكل' : 'Clear All'); ?>
                ...
                <form id="filterForm">
                    ...
                    <div class="filter-section">
                        <div class="filter-section-title" id="priceRangeLabel">
                            ...
                            <?php echo e(is_rtl() ? 'نطاق السعر' : 'Price Range'); ?>

                        </div>

                        <!-- Live Price Labels Above Slider -->
                        <div class="price-range-labels" aria-live="polite" aria-atomic="true">
                            <span class="price-label-min" id="minPriceLabel" aria-label="<?php echo e(is_rtl() ? 'السعر الأدنى' : 'Minimum price'); ?>">₪ <?php echo e(number_format(request('min_price', $priceRange['min']), 0)); ?></span>
                            <span class="price-label-max" id="maxPriceLabel" aria-label="<?php echo e(is_rtl() ? 'السعر الأقصى' : 'Maximum price'); ?>">₪ <?php echo e(number_format(request('max_price', $priceRange['max']), 0)); ?></span>
                        </div>
                        ...
                        <span id="priceRangeDescription" class="sr-only">
                            <?php echo e(is_rtl() ? 'استخدم مفاتيح الأسهم لتعديل نطاق السعر. اضغط Shift مع السهم للتحرك بشكل أسرع.' : 'Use arrow keys to adjust price range. Hold Shift with arrow keys for faster movement.'); ?>
                    ...
                    <div class="filter-accordion">
                        <button type="button"
                            ...
                            <span class="filter-accordion-header">
                                ...
                                <span class="filter-accordion-title"><?php echo e(is_rtl() ? 'الفئات' : 'Categories'); ?></span>
                            </span>
                        ...
                        <fieldset class="filter-accordion-content"
                                  ...
                                  hidden>
                            <legend class="sr-only"><?php echo e(is_rtl() ? 'تصفية حسب الفئة' : 'Filter by category'); ?></legend>
                    ...
                    <div class="filter-accordion">
                        <button type="button"
                            ...
                            <span class="filter-accordion-header">
                                ...
                                <span class="filter-accordion-title"><?php echo e(is_rtl() ? 'العلامات التجارية' : 'Brands'); ?></span>
                            </span>
                            <span class="filter-accordion-icon">
                                <i class="fas fa-plus"></i>
                            </span>
                        ...
                        <fieldset class="filter-accordion-content"
                                  ...
                                  hidden>
                            <legend class="sr-only"><?php echo e(is_rtl() ? 'تصفية حسب العلامة التجارية' : 'Filter by brand'); ?></legend>
                            ...
                            <div class="brand-list" id="brandList">
                                ...
                                <div class="brand-checkbox <?php echo e(!$hasProducts ? 'brand-disabled' : ''); ?>" 
                                    ...
                                    <label for="brand-<?php echo e($brand->slug); ?>">
                                        ...
                                        <span class="item-count <?php echo e(!$hasProducts ? 'count-zero' : ''); ?>"><?php echo e($brand->products_count); ?></span>
                                    </label>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            ...
                            <button type="button"
                                    ...
                                    aria-label="<?php echo e(is_rtl() ? 'عرض المزيد من العلامات التجارية' : 'View more brands'); ?>">
                                <span id="brandViewMoreText"><?php echo e(is_rtl() ? 'عرض المزيد' : 'View more'); ?></span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rashe\Desktop\it-center\laravel-app\resources\views/products.blade.php ENDPATH**/ ?>