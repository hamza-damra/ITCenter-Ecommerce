...
<div class="dashboard-pro">
    ...
    <div class="secondary-stats">
        <div class="mini-stat featured">
            ...
            <span class="mini-stat-badge"><?php echo e(__('messages.promoted_items')); ?></span>
        </div>
        ...
        <div class="mini-stat danger">
            ...
            <span class="mini-stat-badge alert"><?php echo e(__('messages.need_attention')); ?></span>
        </div>
        ...
        <div class="mini-stat reviews">
            ...
            <span class="mini-stat-badge"><?php echo e(__('messages.customer_feedback')); ?></span>
        </div>
        ...
        <div class="mini-stat offers">
            ...
            <span class="mini-stat-badge"><?php echo e(__('messages.running_campaigns')); ?></span>
        </div>
    </div>
        ...
        <div class="content-card quick-actions-card">
            <div class="card-header-pro accent">
                <div class="header-title">
                    ...
                    <h2><?php echo e(__('messages.quick_actions')); ?></h2>
                </div>
            </div>
